...
@class UIWebView, WebSheetPolicyDelegate, UIView, UINavigationBar, UINavigationItem, UIBarButtonItem, UIImageView, UILabel, NSMutableArray, WBUSheetController, WebUIAuthenticationManager, WebUIDownloadManager, UIAlertController, NSTimer, WebSheetViewController, NSURL, NSDictionary, NSString;

@interface WebSheetView : UIView <UINavigationBarDelegate, UIWebViewDelegate, UIWebViewPrivateDelegate> {
...
@property (nonatomic,retain) WebSheetViewController * webSheetViewController;              //@synthesize webSheetViewController=_webSheetViewController - In the implementation block
...
-(WebSheetViewController *)webSheetViewController;
...
-(void)setWebSheetViewController:(WebSheetViewController *)arg1 ;
