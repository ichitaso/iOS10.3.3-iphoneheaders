...
-(float)getXValueForPointFromChartPoint:(id)arg1 ;
-(float)_getYValueForPointFromChartPointValue:(id)arg1 inverted:(char)arg2 ;
-(float)getYValueForPointFromChartPointValue:(id)arg1 ;
