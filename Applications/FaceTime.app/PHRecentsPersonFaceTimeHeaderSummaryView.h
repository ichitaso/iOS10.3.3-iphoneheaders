...
-(id)initWithFrame:(CGRect)arg1 recentCall:(id)arg2 occurrenceDate:(id)arg3 status:(unsigned)arg4 duration:(double)arg5 type:(unsigned)arg6 dataUsage:(int)arg7 ;
