...
@property (assign,nonatomic) SCD_Struct_Di11 arrowMetrics;                                  //@synthesize arrowMetrics=_arrowMetrics - In the implementation block
...
-(void)setArrowMetrics:(SCD_Struct_Di11)arg1 ;
