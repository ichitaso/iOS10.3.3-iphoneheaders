...
+(id)sharedSignStyle;
+(SCD_Struct_Gu2)_arrowMetricsByApplyingScale:(float)arg1 toMetrics:(SCD_Struct_Gu2)arg2 forView:(id)arg3 ;
+(SCD_Struct_Gu2)arrowMetricsForStyle:(int)arg1 scaledToMatchReferenceSize:(CGSize)arg2 forView:(id)arg3 ;
+(SCD_Struct_Gu2)arrowMetricsForStyle:(int)arg1 ;
+(SCD_Struct_Gu2)_defaultArrowMetricsForStyle:(int)arg1 ;
