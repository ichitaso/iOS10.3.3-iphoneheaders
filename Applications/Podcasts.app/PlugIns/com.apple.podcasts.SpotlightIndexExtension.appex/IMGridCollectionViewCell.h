...
@protocol IMGridCollectionViewCellDelegate;
@class UIImageView, UILabel, NSString, UIView, UIActivityIndicatorView, UIButton, UIColor;
...
@interface IMGridCollectionViewCell : UICollectionViewCell {
	...
	id<IMGridCollectionViewCellDelegate> _gridCellDelegate;
...
@property (assign,nonatomic) id<IMGridCollectionViewCellDelegate> gridCellDelegate;              //@synthesize gridCellDelegate=_gridCellDelegate - In the implementation block
...
-(void)setShowCloseBox:(char)arg1 animated:(char)arg2 ;
-(id<IMGridCollectionViewCellDelegate>)gridCellDelegate;
-(void)setGridCellDelegate:(id<IMGridCollectionViewCellDelegate>)arg1 ;
