...
@class NSObject, MFMessageResultsGenerator, NSMutableSet, NSMutableDictionary, NSLock, NSMapTable, NSString;
...
@interface MFMessageBulletinsObserver : NSObject <MFAddressBookClient> {
	...
	NSLock* _summaryClientsLock;
	NSMapTable* _summaryClientsByReference;
...
-(id)messagesForAccountIDs:(id)arg1 count:(unsigned)arg2 clearedInfo:(id)arg3 sinceDate:(id)arg4 ;
-(char)isObservingMailboxID:(id)arg1 inAccountID:(id)arg2 ;
-(void)_nts_invalidateClient:(id)arg1 ;
