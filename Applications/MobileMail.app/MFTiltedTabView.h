...
@interface MFTiltedTabView : UIView <UIGestureRecognizerDelegate, UIScrollViewDelegate, _UIBasicAnimationFactory, CAAnimationDelegate> {
...
-(void)selectItemAtIndex:(unsigned)arg1 animated:(char)arg2 ;
