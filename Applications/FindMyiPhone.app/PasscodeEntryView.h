...
@property (nonatomic,retain) NSLayoutConstraint * horizontalCenteringConstraint;              //@synthesize horizontalCenteringConstraint=_horizontalCenteringConstraint - In the implementation block
-(NSLayoutConstraint *)horizontalCenteringConstraint;
-(void)setHorizontalCenteringConstraint:(NSLayoutConstraint *)arg1 ;
