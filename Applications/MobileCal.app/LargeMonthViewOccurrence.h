...
@property (assign,nonatomic) char isProposedTime;                      //@synthesize isProposedTime=_isProposedTime - In the implementation block
...
-(id)initWithOccurrence:(id)arg1 forDayRange:(NSRange)arg2 isZoomedDay:(char)arg3 isProposedTime:(char)arg4 ;
-(char)isSingleDay;
-(char)isZoomedDay;
-(void)setIsZoomedDay:(char)arg1 ;
-(id)_strikeColor;
-(void)_drawInFrame:(CGRect)arg1 ;
-(UIEdgeInsets)_backgroundInsets;
-(void)_drawBackgroundInFrame:(CGRect)arg1 ;
-(CGPoint)_pointForDotInFrame:(CGRect)arg1 withDotWidth:(float)arg2 ;
-(char)_drawsTimeString;
-(id)_timeColor;
-(NSString *)endTimeString;
-(float)widthDrawingTime:(id)arg1 textRect:(CGRect)arg2 color:(id)arg3 ;
...
-(char)isAllDay;
-(id)occurrence;
-(void)setIsProposedTime:(char)arg1 ;
