...
#import <Feedback Assistant iOS/ACC2SVControllerProtocol.h>
#import <Feedback Assistant iOS/ACC2SVAuthenticationUIControllerDelegate.h>
...
-(void)enterAndVerifySecureCodeOfLength:(unsigned)arg1 ;
-(void)handleErrorOnSendSecurityCode:(id)arg1 alertCancelled:(char)arg2 ;
...
-(unsigned)passcodeLengthFromEncryptedContent:(id)arg1 withHmac:(id)arg2 context:(id)arg3 ;
...
-(void)handleErrorOnResendSecurityCode:(id)arg1 alertCancelled:(char)arg2 ;
