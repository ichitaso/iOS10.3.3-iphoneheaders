...
-(void)captureOutput:(id)arg1 didFinishProcessingLivePhotoToMovieFileAtURL:(id)arg2 duration:(SCD_Struct_MA2)arg3 photoDisplayTime:(SCD_Struct_MA2)arg4 resolvedSettings:(id)arg5 error:(id)arg6;
