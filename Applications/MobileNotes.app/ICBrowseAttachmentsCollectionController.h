...
@property (nonatomic,retain) NSMutableArray * sortedSections;                                    //@synthesize sortedSections=_sortedSections - In the implementation block
...
-(void)setSortedSections:(NSMutableArray *)arg1 ;
...
-(id)attachmentAtIndexPath:(id)arg1 ;
