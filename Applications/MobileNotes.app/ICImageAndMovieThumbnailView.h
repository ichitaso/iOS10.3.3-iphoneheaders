...
@interface ICImageAndMovieThumbnailView : UIView {
	...
	SCD_Struct_IC18 _movieDuration;
...
@property (assign,nonatomic) SCD_Struct_IC18 movieDuration;                                     //@synthesize movieDuration=_movieDuration - In the implementation block
...
-(void)setMovieDuration:(SCD_Struct_IC18)arg1 ;
