...
+(SCD_Struct_DA3)retrieveAccessoryIdentifierForAccessory:(unsigned)arg1 ;
+(id)retrieveReport:(long)arg1 reportResultKey:(id)arg2 accessoryIdentifier:(SCD_Struct_DA3)arg3 ;
+(id)retrieveAllExternalAccessories;
+(id)retrieveKeys:(id)arg1 accessoryIdentifier:(SCD_Struct_DA3)arg2 ;
+(id)retrieveAllPowerSourceInformation;
+(id)retrieveKeys:(id)arg1 reportID:(long)arg2 reportResultKey:(id)arg3 accessoryIdentifier:(SCD_Struct_DA3)arg4 ;
+(id)mergePowerSourceInformation:(id)arg1 accessoryIdentifer:(SCD_Struct_DA3)arg2 externalAccessories:(id)arg3 HIDEntry:(id)arg4 hardModelNumber:(id)arg5 ;
...
+(IOHIDDeviceRef)findMatchingDevice:(_IOHIDDevice*)arg1 count:(long)arg2 accessoryIdentifier:(SCD_Struct_DA3)arg3 ;
