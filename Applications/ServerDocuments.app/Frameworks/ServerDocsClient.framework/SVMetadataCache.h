...
@property (assign,nonatomic) char enableWriteOnlyFolders;                             //@synthesize enableWriteOnlyFolders=_enableWriteOnlyFolders - In the implementation block
@property (assign,nonatomic) int sortOrder;                                           //@synthesize sortOrder=_sortOrder - In the implementation block
@property (nonatomic,readonly) char firstUpdate;                                      //@synthesize firstUpdate=_firstUpdate - In the implementation block
@property (nonatomic,readonly) unsigned numberOfItems; 
@property (nonatomic,readonly) char hasLoadedContents; 
...
-(char)hasLoadedContents;
-(char)firstUpdate;
-(void)cancelDownloadForItem:(id)arg1 ;
-(void)thumbnailForItem:(id)arg1 size:(float)arg2 completionHandler:(/*^block*/id)arg3 ;
-(void)uploadDidFail:(id)arg1 ;
-(void)updateEnabledStateForItems;
-(char)enableWriteOnlyFolders;
...
-(void)setEnableWriteOnlyFolders:(char)arg1 ;
