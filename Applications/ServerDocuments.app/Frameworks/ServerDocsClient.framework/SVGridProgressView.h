...
@property (assign,nonatomic) char onLightBackground;                              //@synthesize onLightBackground=_onLightBackground - In the implementation block
