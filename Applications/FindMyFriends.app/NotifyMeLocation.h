...
@interface NotifyMeLocation : NSObject {
	...
	FMFGeoFence* _fence;
	UIImage* _image;
	SCD_Struct_Ma2 _lastMapRect;

}

@property (nonatomic,retain) FMFGeoFence * fence;                     //@synthesize fence=_fence - In the implementation block
@property (nonatomic,retain) UIImage * image;                         //@synthesize image=_image - In the implementation block
@property (assign,nonatomic) SCD_Struct_Ma2 lastMapRect;              //@synthesize lastMapRect=_lastMapRect - In the implementation block
...
-(SCD_Struct_Ma2)lastMapRect;
-(void)setLastMapRect:(SCD_Struct_Ma2)arg1 ;
