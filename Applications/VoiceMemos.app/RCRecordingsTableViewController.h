...
@class NSIndexPath, NSMutableArray, RCSavedRecording, RCRecordingCell, UITapGestureRecognizer, RCCompositionController, NSString;
...
-(void)_reloadIndexPathsWithBlankRowsCoveringEntireTable:(char)arg1 ;
