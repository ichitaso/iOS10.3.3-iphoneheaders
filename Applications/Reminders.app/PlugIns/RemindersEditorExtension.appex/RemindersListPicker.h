...
#import <RemindersEditorExtension/RemindersListPickerModelDelegate.h>
#import <UIKit/UIPopoverControllerDelegate.h>

@protocol RemindersListPickerDelegate;
@class UITableView, RemindersListPickerModel, UIBarButtonItem, UITextField, NSIndexPath, NSMutableDictionary, EKCalendar, UIPopoverController, NSTimer, UIColor, NSString;
