...
@class UINavigationController, NSMutableArray, NSTimer, SVSTranscriptStackView, NSArray, NSString;
...
@property (assign,setter=_setInUITrackingRunLoopMode:,getter=_isInUITrackingRunLoopMode,nonatomic) char inUITrackingRunLoopMode;                           //@synthesize inUITrackingRunLoopMode=_inUITrackingRunLoopMode - In the implementation block
...
-(void)restoreTopTranscriptPositionAnimated:(char)arg1 ;
...
-(char)_isInUITrackingRunLoopMode;
-(void)_setInUITrackingRunLoopMode:(char)arg1 ;
