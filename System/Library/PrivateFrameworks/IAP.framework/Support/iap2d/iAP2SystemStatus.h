...
-(void)UnplugBTDevice:(id)arg1 btAccessoryManager:(BTAccessoryManagerImplRef)arg2 btDevice:(BTDeviceImplRef)arg3 btName:(const char*)arg4 ;
...
-(void)PluginBTDevice:(id)arg1 btAccessoryManager:(BTAccessoryManagerImplRef)arg2 btDevice:(BTDeviceImplRef)arg3 btName:(const char*)arg4 ;
-(id)GetNowPlayingApp;
