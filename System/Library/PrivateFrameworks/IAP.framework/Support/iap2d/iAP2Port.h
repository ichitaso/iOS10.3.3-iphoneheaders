...
+(id)FindPortForPort:(int)arg1 andMacAddress:(id)arg2 ;
...
+(id)FindPortForEAProtocolMacAddress:(id)arg1 ;
...
-(char)IsBluetoothLE;
-(char)IsWireless;
-(int)PortAppleIDBusAuthStateCertCaps:(const void*)arg1 certSerial:(id*)arg2 ;
-(void)SendDeviceGoToSleepAndPowerOffPort:(id)arg1 ;
