...
@interface iAP2IdentificationInfo : iAP2IdentificationParameter {
	...
	NSMutableDictionary* cameraFormats;
	NSMutableDictionary* cameraComponents;
	NSMutableDictionary* navigationDisplayComponents;
...
@property (assign) int maximumSiphoningCurrent; 
...
@property (retain) NSMutableDictionary * cameraFormats; 
@property (retain) NSMutableDictionary * cameraComponents; 
@property (retain) NSMutableDictionary * navigationDisplayComponents; 
...
-(int)createCameraFormats;
-(int)createCameraComponents;
-(int)createNavigationDisplayComponents;
...
-(int)addCameraFormat:(id)arg1 ;
-(int)addCameraComponent:(id)arg1 ;
-(int)addNavigationDisplayComponent:(id)arg1 ;
...
-(int)maximumSiphoningCurrent;
-(void)setMaximumSiphoningCurrent:(int)arg1 ;
-(void)setEaProtocols:(NSMutableDictionary *)arg1 ;
-(void)setCameraFormats:(NSMutableDictionary *)arg1 ;
-(void)setNavigationDisplayComponents:(NSMutableDictionary *)arg1 ;
