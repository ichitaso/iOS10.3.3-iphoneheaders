...
@interface iAP2SessionEATransport : iAP2EASession {
	...
	unsigned long long _deviceRegistryID;
	NSString* _protocolName;
	NSObject*<OS_dispatch_queue> _msgSerialQueue;
	NSObject*<OS_dispatch_source> _listenSource;
	NSObject*<OS_dispatch_source> _readSource;
	unsigned _eaProtocolConnect;
	unsigned _eaProtocolService;
	IONotificationPortRef _eaProtocolNotificationPort;
...
-(void)_registerEAReadCB;
-(void)_openPipeFromAppOnThread;
-(void)_cancelThread;
-(id)_dequeueWriteBuffer;
-(void)_writeEASessionData:(id)arg1 ;
