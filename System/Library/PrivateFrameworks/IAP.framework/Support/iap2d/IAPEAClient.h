...
@property (nonatomic,readonly) SCD_Struct_IA13 auditToken;                          //@synthesize auditToken=_auditToken - In the implementation block
...
-(id)initWithCapabilities:(unsigned)arg1 auditToken:(SCD_Struct_IA13)arg2 xpcConnection:(id)arg3 eaProtocols:(id)arg4 andBundleId:(id)arg5 ;
