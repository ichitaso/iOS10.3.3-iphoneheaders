...
-(void)_drawSpecificRenditionKey:(id)arg1 inFrame:(CGRect)arg2 context:(CGContextRef)arg3 alpha:(float)arg4 operation:(int)arg5 isFocused:(int)arg6 isFlipped:(char)arg7 effects:(id)arg8 ;
...
-(void)_drawSpecificRenditionKey:(id)arg1 inFrame:(CGRect)arg2 context:(CGContextRef)arg3 isFocused:(int)arg4 isFlipped:(char)arg5 effects:(id)arg6 ;
-(void)drawInFrame:(CGRect)arg1 alpha:(float)arg2 operation:(int)arg3 isFocused:(int)arg4 context:(CGContextRef)arg5 effects:(id)arg6 ;
-(id)themeRendition;
...
-(void)_drawSpecificRenditionKey:(id)arg1 rendition:(id)arg2 inFrame:(CGRect)arg3 context:(CGContextRef)arg4 alpha:(float)arg5 operation:(int)arg6 isFocused:(int)arg7 isFlipped:(char)arg8 effects:(id)arg9 ;
...
-(void)drawInFrame:(CGRect)arg1 alpha:(float)arg2 isFocused:(int)arg3 context:(CGContextRef)arg4 effects:(id)arg5 ;
