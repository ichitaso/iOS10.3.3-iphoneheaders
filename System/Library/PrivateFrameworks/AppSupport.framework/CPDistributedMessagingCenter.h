...
+(id)_centerNamed:(id)arg1 requireLookupByPID:(char)arg2 ;
+(id)pidRestrictedCenterNamed:(id)arg1 ;
+(id)centerNamed:(id)arg1 ;
-(id)_initWithServerName:(id)arg1 ;
-(id)_initWithServerName:(id)arg1 requireLookupByPID:(char)arg2 ;
-(void)_setSendPort:(unsigned)arg1 ;
-(void)_setupInvalidationSource;
-(char)_sendMessage:(id)arg1 userInfo:(id)arg2 receiveReply:(id*)arg3 error:(id*)arg4 toTarget:(id)arg5 selector:(SEL)arg6 context:(void*)arg7 ;
-(char)_sendMessage:(id)arg1 userInfo:(id)arg2 receiveReply:(id*)arg3 error:(id*)arg4 toTarget:(id)arg5 selector:(SEL)arg6 context:(void*)arg7 nonBlocking:(char)arg8 ;
-(char)_sendMessage:(id)arg1 userInfoData:(id)arg2 oolKey:(id)arg3 oolData:(id)arg4 makeServer:(char)arg5 receiveReply:(id*)arg6 nonBlocking:(char)arg7 error:(id*)arg8 ;
-(unsigned)_sendPort;
-(id)_initAnonymousServer;
-(void)_sendReplyMessage:(id)arg1 portPassing:(char)arg2 onMachPort:(unsigned)arg3 ;
-(id)_initClientWithPort:(unsigned)arg1 ;
-(char)sendMessageName:(id)arg1 userInfo:(id)arg2 ;
...
-(char)_isTaskEntitled:(SCD_Struct_CP4*)arg1 ;
...
-(char)sendNonBlockingMessageName:(id)arg1 userInfo:(id)arg2 ;
