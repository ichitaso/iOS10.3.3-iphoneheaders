...
+(int)UDisplayContextForIUDisplayNameContext:(unsigned)arg1 ;
...
-(void)dealloc;
-(id)displayNameForNormalizedLanguage:(id)arg1 context:(unsigned)arg2 displayLanguage:(id)arg3 ;
-(id)ICUdisplayNameForLanguage:(id)arg1 capitalization:(ULocaleDisplayNamesRef)arg2 ;
-(id)displayNameForRegion:(id)arg1 displayLanguage:(id)arg2 capitalization:(unsigned)arg3 short:(char)arg4 ;
-(id)displayNameForLabelForLunarCalendarID:(id)arg1 displayLanguage:(id)arg2 ;
-(id)localizedLanguageForLanguage:(id)arg1 ;
-(id)displayNameForDialect:(id)arg1 context:(unsigned)arg2 displayLanguage:(id)arg3 ;
-(id)displayNameForLocale:(id)arg1 displayLanguage:(id)arg2 capitalization:(unsigned)arg3 short:(char)arg4 ;
-(char)canRenderLanguage:(id)arg1 ;
-(id)localizedNameForScript:(short)arg1 ;
-(id)displayNameForLanguage:(id)arg1 context:(unsigned)arg2 displayLanguage:(id)arg3 ;
-(id)displayNameForRegion:(id)arg1 displayLanguage:(id)arg2 capitalization:(unsigned)arg3 ;
-(id)languageList;
@end
