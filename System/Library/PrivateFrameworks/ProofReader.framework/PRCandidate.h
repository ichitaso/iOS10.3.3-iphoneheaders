...
+(id)candidateWithBuffer:(char*)arg1 encoding:(unsigned long)arg2 transform:(unsigned)arg3 replacementRange:(NSRange)arg4 errorScore:(double)arg5 ;
+(id)candidateWithWords:(id)arg1 replacementRange:(NSRange)arg2 errorScore:(double)arg3 ;
+(id)candidateWithWords:(id)arg1 replacementRange:(NSRange)arg2 errorType:(unsigned)arg3 ;
+(id)candidateWithString:(id)arg1 replacementRange:(NSRange)arg2 errorType:(unsigned)arg3 ;
...
+(id)candidateWithBuffer:(char*)arg1 encoding:(unsigned long)arg2 transform:(unsigned)arg3 replacementRange:(NSRange)arg4 errorType:(unsigned)arg5 ;
+(id)replacementCandidateWithBuffer:(char*)arg1 encoding:(unsigned long)arg2 transform:(unsigned)arg3 replacementRange:(NSRange)arg4 intendedCharacter:(unsigned short)arg5 actualCharacter:(unsigned short)arg6 ;
+(id)transpositionCandidateWithBuffer:(char*)arg1 encoding:(unsigned long)arg2 transform:(unsigned)arg3 replacementRange:(NSRange)arg4 intendedFirstCharacter:(unsigned short)arg5 intendedSecondCharacter:(unsigned short)arg6 ;
