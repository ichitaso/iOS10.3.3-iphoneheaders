...
@property (assign,nonatomic) char forceSingleLineLayout;                                                          //@synthesize forceSingleLineLayout=_forceSingleLineLayout - In the implementation block
...
-(void)setForceSingleLineLayout:(char)arg1 ;
