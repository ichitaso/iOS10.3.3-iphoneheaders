...
@property (nonatomic,readonly) char hasOnlySlottedCandidates; 
@property (nonatomic,readonly) unsigned slottedCandidatesCount; 
...
+(id)setWithCandidates:(id)arg1 initialSelectedIndex:(unsigned)arg2 defaultCandidate:(id)arg3 sortMethods:(id)arg4 sortMethodGroups:(id)arg5 indexTitles:(id)arg6 showExtensionCandidates:(id)arg7 initiallyHiddenCandidates:(id)arg8 selectedHiddenCandidateIndex:(unsigned)arg9 ;
+(id)setWithCandidates:(id)arg1 initialSelectedIndex:(unsigned)arg2 defaultCandidate:(id)arg3 sortMethods:(id)arg4 sortMethodGroups:(id)arg5 indexTitles:(id)arg6 showExtensionCandidates:(id)arg7 initiallyHiddenCandidates:(id)arg8 selectedHiddenCandidateIndex:(unsigned)arg9 proactiveTriggers:(id)arg10 ;
-(char)candidatesForSortIndexShowAlternativeText:(int)arg1 ;
-(id)candidateGroupsForSortIndex:(int)arg1 ;
-(char)hasOnlySlottedCandidates;
-(unsigned)slottedCandidatesCount;
-(char)hasOnlyProactiveCandidates;
-(id)initWithCandidates:(id)arg1 initialSelectedIndex:(unsigned)arg2 defaultCandidate:(id)arg3 sortMethods:(id)arg4 sortMethodGroups:(id)arg5 indexTitles:(id)arg6 showExtensionCandidates:(id)arg7 initiallyHiddenCandidates:(id)arg8 selectedHiddenCandidateIndex:(unsigned)arg9 proactiveTriggers:(id)arg10 ;
