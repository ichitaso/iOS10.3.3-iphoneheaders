...
-(id)pathToInstalledProfileByIdentifier:(id)arg1 installationType:(int)arg2 ;
...
-(id)_installedProfileWithIdentifier:(id)arg1 installationType:(int)arg2 ;
...
-(id)updateProfileWithIdentifier:(id)arg1 interactionClient:(id)arg2 installForSystem:(char)arg3 outError:(id*)arg4 ;
-(id)_profileNotEligibleErrorWithProfile:(id)arg1 ;
-(void)_reallyRemoveProfileWithIdentifier:(id)arg1 installationType:(int)arg2 ;
-(void)_cleanUpAfterRemovingProfileWithIdentifier:(id)arg1 installedForUser:(char)arg2 profileHandler:(id)arg3 oldRestrictions:(id)arg4 ;
