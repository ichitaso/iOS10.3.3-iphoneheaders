...
@property (nonatomic,retain) NSObject*<OS_dispatch_queue> clientRestrictionQueue;              //@synthesize clientRestrictionQueue=_clientRestrictionQueue - In the implementation block
@property (nonatomic,retain) NSObject*<OS_dispatch_queue> mailAccountsQueue;                   //@synthesize mailAccountsQueue=_mailAccountsQueue - In the implementation block
...
-(NSObject*<OS_dispatch_queue>)clientRestrictionQueue;
...
-(void)filteredMailAccountsWithAuditToken:(SCD_Struct_MC0)arg1 sourceAccountManagement:(int)arg2 completion:(/*^block*/id)arg3 ;
...
-(void)setDictationAllowed:(char)arg1 senderPID:(int)arg2 completion:(/*^block*/id)arg3 ;
...
-(void)setParametersForSettingsByType:(id)arg1 configurationUUID:(id)arg2 toSystem:(char)arg3 user:(char)arg4 passcode:(id)arg5 senderPID:(int)arg6 completion:(/*^block*/id)arg7 ;
...
-(void)setClientRestrictionQueue:(NSObject*<OS_dispatch_queue>)arg1 ;
-(NSObject*<OS_dispatch_queue>)mailAccountsQueue;
-(void)setMailAccountsQueue:(NSObject*<OS_dispatch_queue>)arg1 ;
...
-(void)applyRestrictionDictionary:(id)arg1 appsAndOptions:(id)arg2 clientType:(id)arg3 clientUUID:(id)arg4 localizedClientDescription:(id)arg5 localizedWarningMessage:(id)arg6 completion:(/*^block*/id)arg7 ;
