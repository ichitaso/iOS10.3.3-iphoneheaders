...
-(char)remoteProcessHasBooleanEntitlement:(id)arg1 ;
-(id)lacksBooleanEntitlementError:(id)arg1 ;
-(char)remoteProcessHasEntitlementArray:(id)arg1 containingString:(id)arg2 ;
-(id)lacksArrayEntitlementError:(id)arg1 withMemberString:(id)arg2 ;
-(char)remoteProcessHasEntitlementArray:(id)arg1 containingString:(id)arg2 error:(id*)arg3 ;
-(char)isCloudLockedProfileWithIdentifier:(id)arg1 ;
-(char)remoteProcessHasBooleanEntitlement:(id)arg1 error:(id*)arg2 ;
...
-(void)setKeyboardShortcutsAllowed:(char)arg1 completion:(/*^block*/id)arg2 ;
-(void)setSpellCheckAllowed:(char)arg1 completion:(/*^block*/id)arg2 ;
-(void)setDictationAllowed:(char)arg1 completion:(/*^block*/id)arg2 ;
...
-(void)mayShareToAirDropAndOriginatingAccountIsManaged:(char)arg1 completion:(/*^block*/id)arg2 ;
...
-(void)setParametersForSettingsByType:(id)arg1 configurationUUID:(id)arg2 toSystem:(char)arg3 user:(char)arg4 passcode:(id)arg5 completion:(/*^block*/id)arg6 ;
...
-(void)showFeaturePromptForSetting:(id)arg1 configurationUUID:(id)arg2 promptOptions:(id)arg3 promptIdentifier:(id)arg4 completion:(/*^block*/id)arg5 ;
-(void)cancelFeaturePromptWithIdentifier:(id)arg1 completion:(/*^block*/id)arg2 ;
