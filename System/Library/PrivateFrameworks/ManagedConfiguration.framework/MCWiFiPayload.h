...
@property (assign,nonatomic) char captiveBypass;                                                                     //@synthesize captiveBypass=_captiveBypass - In the implementation block
...
-(char)_qosMarkingConfigIsValid:(id)arg1 error:(id*)arg2 ;
