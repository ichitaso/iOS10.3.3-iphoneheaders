...
+(id)restrictionsWithCurrentRestrictions:(id)arg1 defaultRestrictions:(id)arg2 systemProfileRestrictions:(id)arg3 userProfileRestrictions:(id)arg4 systemClientRestrictions:(id)arg5 userClientRestrictions:(id)arg6 outRestrictionsChanged:(char*)arg7 outError:(id*)arg8 ;
...
+(int)defaultBoolValueForSetting:(id)arg1 outAsk:(char*)arg2 ;
+(int)boolSettingForFeature:(id)arg1 outAsk:(char*)arg2 withUserSettingDictionary:(id)arg3 ;
+(id)parametersForSetting:(id)arg1 ofType:(id)arg2 withUserSettingDictionary:(id)arg3 ;
+(char)isWhitelistedAppsRestrictionEnforcedWithRestrictionsDictionary:(id)arg1 ;
...
-(id)restrictedAppBundleIDsExcludingRemovedSystemApps:(char)arg1 ;
-(int)effectiveRestrictedBoolForSetting:(id)arg1 ;
-(id)effectiveBlacklistedAppBundleIDsExcludingRemovedSystemApps:(char)arg1 ;
...
-(id)restrictionEnforcedBlacklistedAppBundleIDsExcludingRemovedSystemApps:(char)arg1 ;
...
-(char)allowedToRunAppWithBundleID:(id)arg1 ;
