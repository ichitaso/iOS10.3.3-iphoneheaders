...
-(void)importArtworkForCloudID:(unsigned long long)arg1 artworkType:(int)arg2 token:(id)arg3 mediaType:(unsigned long)arg4 allowsCellularData:(char)arg5 completionHandler:(/*^block*/id)arg6 ;
