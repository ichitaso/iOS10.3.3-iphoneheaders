...
-(void)setCloudAddToPlaylistBehavior:(int)arg1 completion:(/*^block*/id)arg2 ;
...
-(void)importScreenshotForSagaID:(unsigned long long)arg1 completion:(/*^block*/id)arg2 ;
...
-(void)importSubscriptionScreenshotForPersistentID:(long long)arg1 completion:(/*^block*/id)arg2 ;
...
-(void)setCollectionProperties:(id)arg1 forCollectionWithPersistentID:(long long)arg2 groupingType:(int)arg3 completion:(/*^block*/id)arg4 ;
