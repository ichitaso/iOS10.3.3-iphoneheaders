...
-(void)updateSubscribedPlaylistsWithSagaIDs:(id)arg1 ignoreMinRefreshInterval:(char)arg2 requestReason:(long long)arg3 completionHandler:(/*^block*/id)arg4 ;
...
-(void)setCloudAddToPlaylistBehavior:(int)arg1 completionHandler:(/*^block*/id)arg2 ;
-(id)_library;
