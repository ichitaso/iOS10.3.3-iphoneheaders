...
-(int)callHTTPTestFromIPPort:(tagIPPORT*)arg1 ipv6Prefix:(const SCD_Struct_GK3*)arg2 ToServer:(id)arg3 isSSL:(char)arg4 ;
-(void)NATCheckWithIPPort:(tagIPPORT*)arg1 ipv6Prefix:(const SCD_Struct_GK3*)arg2 useCache:(char)arg3 ;
-(void)HTTPCheckWithIPPort:(tagIPPORT*)arg1 ipv6Prefix:(const SCD_Struct_GK3*)arg2 useCache:(char)arg3 ;
-(void)HTTPSCheckWithIPPort:(tagIPPORT*)arg1 ipv6Prefix:(const SCD_Struct_GK3*)arg2 useCache:(char)arg3 ;
