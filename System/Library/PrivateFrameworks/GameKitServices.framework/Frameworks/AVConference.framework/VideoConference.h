...
-(void)cancelCallID:(unsigned long)arg1 ;
...
-(void)setConferenceState:(unsigned)arg1 forCallID:(unsigned long)arg2 ;
-(void)setConferenceVisualRectangle:(CGRect)arg1 forCallID:(unsigned long)arg2 ;
-(void)setPeerProtocolVersion:(unsigned)arg1 forCallID:(unsigned long)arg2 ;
...
-(int)currentCameraID;
-(void)session:(id)arg1 connectionDidChangeWithLocalInterfaceType:(id)arg2 remoteInterfaceType:(id)arg3 callID:(unsigned long)arg4 ;
...
-(void)session:(id)arg1 didReceiveData:(id)arg2 messageType:(unsigned long)arg3 withCallID:(unsigned long)arg4 ;
...
-(void)session:(id)arg1 cleanUpWithDelay:(int)arg2 error:(id)arg3 ;
...
-(char)startConnectionWithParticipantID:(id)arg1 callID:(unsigned long)arg2 usingInviteData:(id)arg3 isCaller:(char)arg4 relayResponseDict:(id)arg5 didOriginateRelayRequest:(char)arg6 capabilities:(id)arg7 idsSocket:(int)arg8 destination:(id)arg9 error:(id*)arg10 ;
-(id)sessionForParticipantID:(id)arg1 ;
-(void)stopCallID:(unsigned long)arg1 didRemoteCancel:(char)arg2 error:(id)arg3 ;
-(void)cancelCallID:(unsigned long)arg1 error:(id)arg2 ;
-(int)tryrdlock;
...
-(int)conferenceOperatingMode;
-(char)startConnectionWithParticipantID:(id)arg1 callID:(unsigned long)arg2 oldCallID:(unsigned long)arg3 usingInviteData:(id)arg4 isCaller:(char)arg5 relayResponseDict:(id)arg6 didOriginateRelayRequest:(char)arg7 capabilities:(id)arg8 idsSocket:(int)arg9 destination:(id)arg10 error:(id*)arg11 ;
...
-(BOOL)session:(id)arg1 receivedRemoteFrame:(CVBufferRef)arg2 atTime:(SCD_Struct_VC21)arg3 withScreenAttributes:(id)arg4 videoAttributes:(id)arg5 isFirstFrame:(char)arg6 isVideoPaused:(char)arg7 ;
