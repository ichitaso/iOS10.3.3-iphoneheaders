...
-(void)vcArg:(id)arg1 sendControlData:(id)arg2 isTypeSSL:(char)arg3 withTimeout:(float)arg4 withDetail:(int)arg5 ;
-(id)bindingResponseHandler;
-(char)sendRefreshMsg:(unsigned)arg1 error:(id*)arg2 ;
-(id)destroyHandler;
-(char)sendChannelBindingMsgWithDict:(id)arg1 error:(id*)arg2 ;
