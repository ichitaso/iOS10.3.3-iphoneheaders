...
+(void)_addSubscriptionOperationWithType:(int)arg1 message:(id)arg2 connection:(id)arg3 ;
+(void)installManagedAppWithMessage:(id)arg1 connection:(id)arg2 provideDetailedResponse:(char)arg3 ;
