...
-(char)_pauseDownloads:(id)arg1 isForced:(char)arg2 client:(id)arg3 ;
-(char)_resumeDownloads:(id)arg1 client:(id)arg2 ;
-(char)_cancelDownloads:(id)arg1 client:(id)arg2 ;
-(void)_retryRestoreIfNecessaryForTransaction:(id)arg1 ;
-(void)_rescueStuckPlaceholderWithBundleID:(id)arg1 ;
-(void)_filterAndTranslateProperties:(id)arg1 usingBlock:(/*^block*/id)arg2 ;
-(char)_prioritizeDownload:(id)arg1 aboveDownload:(id)arg2 client:(id)arg3 error:(id*)arg4 ;
-(char)_restartDownloads:(id)arg1 client:(id)arg2 ;
