...
@interface StoreDownloadQueue : NSObject {
	...
	char _restoreItemsUnavailableScheduled;
...
-(char)checkQueuesWithReason:(id)arg1 ;
-(void)commitAutomaticDownloadKinds:(id)arg1 markAsDirty:(char)arg2 ;
