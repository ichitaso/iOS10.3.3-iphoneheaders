...
@interface DaemonPlayActivityController : SSVPlayActivityController {
	...
	char _hasValidCurrentJingleRevision;
	char _hasValidCurrentRevision;
	unsigned _flushingTransactionCount;
	char _isJingleFlushTimerEnabled;
	char _isStarted;
...
-(void)_flushWithTimerReset:(char)arg1 completionHandler:(/*^block*/id)arg2 ;
-(void)_setJingleFlushTimerEnabled:(char)arg1 ;
