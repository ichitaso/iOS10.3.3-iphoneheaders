...
+(char)_isConnectionEntitled:(id)arg1 ;
...
-(char)_resumeUploadsWithPredicate:(id)arg1 clientIdentifier:(id)arg2 resetFailureCount:(char)arg3 error:(id*)arg4 ;
-(char)_cancelUploadsWithPredicate:(id)arg1 clientIdentifier:(id)arg2 error:(id*)arg3 ;
...
-(char)_pauseUploadsWithPredicate:(id)arg1 clientIdentifier:(id)arg2 error:(id*)arg3 ;
-(void)_registerObserverWithMessage:(id)arg1 connection:(id)arg2 ;
-(void)_cleanupSessionController;
-(id)_newSSVDirectUploadWithProgress:(id)arg1 state:(int)arg2 ;
...
-(void)mediaSocialErrorCoordinator:(id)arg1 didFinishWithResult:(int)arg2 ;
