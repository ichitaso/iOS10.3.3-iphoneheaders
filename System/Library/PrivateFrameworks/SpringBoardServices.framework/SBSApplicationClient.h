...
-(void)setRemovalAllowed:(char)arg1 forBundleIdentifier:(id)arg2 withCompletionHandler:(/*^block*/id)arg3 ;
...
-(void)fetchApplicationShortcutItemsOfTypes:(unsigned)arg1 forBundleIdentifier:(id)arg2 withCompletionHandler:(/*^block*/id)arg3 ;
