...
+(char)__isPropertyTypeValid:(char)arg1 class:(Class)arg2 ;
+(void)initialize;
...
-(char)_isCollectionEmpty:(id)arg1 ;
-(id)_store;
-(id)init;
-(void)dealloc;
-(id)description;
-(void)_bindProperty:(id)arg1 withDefaultKey:(id)arg2 toDefaultValue:(id)arg3 options:(unsigned)arg4 ;
