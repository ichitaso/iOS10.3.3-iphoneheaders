...
@property (assign) int advertisementVersion;                 //@synthesize advertisementVersion=_advertisementVersion - In the implementation block
...
-(void)setAdvertisementVersion:(int)arg1 ;
-(id)init;
