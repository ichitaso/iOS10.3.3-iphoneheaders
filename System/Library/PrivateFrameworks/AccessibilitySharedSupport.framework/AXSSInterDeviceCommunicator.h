...
@interface AXSSInterDeviceCommunicator : NSObject <IDSServiceDelegate, MCSessionDelegate, MCNearbyServiceBrowserDelegate, MCNearbyServiceAdvertiserDelegate> {
	...
	unsigned _numberOfBurstPacketsRemaining;
...
@property (assign,nonatomic) unsigned numberOfBurstPacketsRemaining;                                //@synthesize numberOfBurstPacketsRemaining=_numberOfBurstPacketsRemaining - In the implementation block
...
-(void)setNumberOfBurstPacketsRemaining:(unsigned)arg1 ;
...
-(unsigned)numberOfBurstPacketsRemaining;
-(void)_advertise;
