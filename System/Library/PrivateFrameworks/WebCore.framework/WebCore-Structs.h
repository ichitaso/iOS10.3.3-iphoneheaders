...
typedef const struct FontCascadeFontCascadeDescriptionFontTaggedSettings<int>Vector<WebCore::FontTaggedSetting<int>, 0, WTF::CrashOnOverflow, 16>FontTaggedSetting<int>IIFontVariationSettingsAtomicStringStringRefPtr<WTF::StringImpl>StringImplfb1b1b2b1b8b1b2b7b3b2b2b2b2b2b3b2b2b2b1b1b1b3b2b1RefCountedArray<WTF::AtomicString>AtomicStringfb1b2b4b2b1RefPtr<WebCore::FontCascadeFonts>FontCascadeFontsWeakPtrFactory<WebCore::FontCascade>Ref<WTF::WeakReference<WebCore::FontCascade> >WeakReference<WebCore::FontCascade>ffBb1b1* ontCascadeRef;
