...
-(id)initWithKeyEventType:(int)arg1 timeStamp:(double)arg2 characters:(id)arg3 charactersIgnoringModifiers:(id)arg4 modifiers:(unsigned)arg5 isRepeating:(char)arg6 withFlags:(unsigned)arg7 withInputManagerHint:(id)arg8 keyCode:(unsigned short)arg9 isTabKey:(char)arg10 ;
