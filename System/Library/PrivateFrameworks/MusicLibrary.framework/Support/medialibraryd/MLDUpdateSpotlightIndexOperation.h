...
-(char)_enumerateSearchableItemsWithPersistentIDs:(id)arg1 entityType:(int)arg2 error:(id*)arg3 usingBlock:(/*^block*/id)arg4 ;
-(id)_createSearchableItemsWithPersistentIDs:(id)arg1 entityType:(int)arg2 error:(id*)arg3 ;
