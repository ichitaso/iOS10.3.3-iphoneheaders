...
@property (assign) char wiFiAsserted;                                              //@synthesize wiFiAsserted=_wiFiAsserted - In the implementation block
...
@property (retain) NSString * currentConnectionUUID;                               //@synthesize currentConnectionUUID=_currentConnectionUUID - In the implementation block
@property (retain) NSString * currentSetupMessageUUID;                             //@synthesize currentSetupMessageUUID=_currentSetupMessageUUID - In the implementation block
...
-(char)wiFiAsserted;
-(void)setWiFiAsserted:(char)arg1 ;
-(void)_waitForSocket;
...
-(void)_onInternalQueue_beginUsingSocketAsDelegate:(id)arg1 onQueue:(id)arg2 tryWiFi:(char)arg3 completion:(/*^block*/id)arg4 ;
...
-(void)setCurrentConnectionUUID:(NSString *)arg1 ;
-(NSString *)currentConnectionUUID;
-(void)_onQueue_startSocketSetupTimer;
-(id)_sendMessage:(id)arg1 messageDictionary:(id)arg2 withAcknowledgement:(char)arg3 error:(id*)arg4 ;
-(void)setCurrentSetupMessageUUID:(NSString *)arg1 ;
...
-(void)handleIDSRelayConnectionResponseWithContext:(id)arg1 ;
-(void)beginUsingSocketAsDelegate:(id)arg1 onQueue:(id)arg2 tryWiFi:(char)arg3 completion:(/*^block*/id)arg4 ;
-(void)endUsingSocket;
-(void)resetSocket;
