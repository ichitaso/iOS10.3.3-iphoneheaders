...
-(void)_setupWelcomeScreen;
-(void)_setupHashtagImages;
-(void)_terminate;
...
-(void)requestQOSClassWhileServicingRequestsWithID:(id)arg1 messageContext:(id)arg2 ;
...
-(void)markPlayedExpressiveSendForIDs:(id)arg1 style:(unsigned char)arg2 onServices:(id)arg3 message:(id)arg4 messageContext:(id)arg5 ;
...
-(void)debugUpdateGroupParticipantversion:(unsigned)arg1 chatIdentifier:(id)arg2 messageContext:(id)arg3 ;
...
-(void)downloadStickerWithGUID:(id)arg1 messageContext:(id)arg2 ;
-(void)downloadStickerPackWithGUID:(id)arg1 isIncomingMessage:(char)arg2 ignoreCache:(char)arg3 messageContext:(id)arg4 ;
...
-(void)markAsSpamForIDs:(id)arg1 style:(unsigned char)arg2 onServices:(id)arg3 chatID:(id)arg4 queryID:(id)arg5 autoReport:(char)arg6 messageContext:(id)arg7 ;
...
-(void)cancelVCRequestWithPerson:(id)arg1 properties:(id)arg2 conference:(id)arg3 reason:(id)arg4 account:(id)arg5 messageContext:(id)arg6 ;
...
-(void)leaveiMessageChatID:(id)arg1 identifier:(id)arg2 style:(unsigned char)arg3 account:(id)arg4 messageContext:(id)arg5 ;
...
-(void)invitePersonInfoToiMessageChat:(id)arg1 withMessage:(id)arg2 toChatID:(id)arg3 identifier:(id)arg4 style:(unsigned char)arg5 account:(id)arg6 messageContext:(id)arg7 ;
...
-(void)removePersonInfoFromiMessageChat:(id)arg1 chatID:(id)arg2 identifier:(id)arg3 style:(unsigned char)arg4 account:(id)arg5 messageContext:(id)arg6 ;
...
-(void)sendBalloonPayload:(id)arg1 attachments:(id)arg2 withMessageGUID:(id)arg3 bundleID:(id)arg4 messageContext:(id)arg5 ;
-(void)updateBalloonPayload:(id)arg1 attachments:(id)arg2 forMessageGUID:(id)arg3 messageContext:(id)arg4 ;
...
-(void)terminateForcingIfNeeded:(char)arg1 ;
