...
@property (assign,nonatomic) int leaseAction;                                                                                        //@synthesize leaseAction=_leaseAction - In the implementation block
...
@property (assign) char skippedRentalCheckout;                                                                                       //@synthesize skippedRentalCheckout=_skippedRentalCheckout - In the implementation block
@property (getter=isITunesStoreRequest) char ITunesStoreRequest; 
@property (assign,nonatomic) char shouldIncludeGUID; 
...
-(void)setShouldIncludeGUID:(char)arg1 ;
