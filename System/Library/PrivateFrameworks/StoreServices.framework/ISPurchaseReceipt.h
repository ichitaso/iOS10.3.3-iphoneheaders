...
-(int)_verifySignatureForSignedData:(SecCmsSignedDataStrRef)arg1 onDate:(id)arg2 ;
-(char)_checkIfCertificate:(SecCertificateRef)arg1 containsOID:(CFStringRef)arg2 ;
-(void)_parseTokens:(id)arg1 ;
-(CFArrayRef)_copyCertificatesFromSignedData:(SecCmsSignedDataStrRef)arg1 ;
-(char)_checkArray:(CFArrayRef)arg1 containsCertificateWithOID:(CFStringRef)arg2 ;
-(char)_setPoliciesForTrust:(SecTrustRef)arg1 ;
-(char)_anchorTrust:(SecTrustRef)arg1 toRootCertificateIn:(CFArrayRef)arg2 ;
