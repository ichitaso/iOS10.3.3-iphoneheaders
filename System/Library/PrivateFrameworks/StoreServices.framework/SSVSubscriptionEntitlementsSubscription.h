...
@property (assign,getter=isNewsAppPurchase,nonatomic) char newsAppPurchase;              //@synthesize newsAppPurchase=_newsAppPurchase - In the implementation block
...
-(void)setNewsAppPurchase:(char)arg1 ;
