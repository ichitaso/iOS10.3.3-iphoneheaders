...
@property (assign,setter=_setReloadUrgencyType:,nonatomic) int reloadUrgencyType;                         //@synthesize reloadUrgencyType=_reloadUrgencyType - In the implementation block
