...
-(void)postMetric:(id)arg1 withIdentifier:(unsigned long)arg2 libnetcore:(char)arg3 ;
-(void)bulkPostMetrics:(id)arg1 withIdentifier:(unsigned long)arg2 libnetcore:(char)arg3 ;
