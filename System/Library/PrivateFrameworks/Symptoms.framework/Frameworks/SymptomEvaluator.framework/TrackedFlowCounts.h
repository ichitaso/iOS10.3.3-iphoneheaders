...
@interface TrackedFlowCounts : NSObject {
	...
	char _probedFlow;
	char _probed3WHSStuckFlow;
	char _probedReadStuckFlow;
	char _probedWriteStuckFlow;
...
@property (assign,nonatomic) char probedFlow;                                 //@synthesize probedFlow=_probedFlow - In the implementation block
@property (assign,nonatomic) char probed3WHSStuckFlow;                        //@synthesize probed3WHSStuckFlow=_probed3WHSStuckFlow - In the implementation block
@property (assign,nonatomic) char probedReadStuckFlow;                        //@synthesize probedReadStuckFlow=_probedReadStuckFlow - In the implementation block
@property (assign,nonatomic) char probedWriteStuckFlow;                       //@synthesize probedWriteStuckFlow=_probedWriteStuckFlow - In the implementation block
-(id)description;
...
-(void)setProbedFlow:(char)arg1 ;
-(void)setProbed3WHSStuckFlow:(char)arg1 ;
-(void)setProbedReadStuckFlow:(char)arg1 ;
-(void)setProbedWriteStuckFlow:(char)arg1 ;
...
-(char)probedFlow;
-(char)probed3WHSStuckFlow;
-(char)probedReadStuckFlow;
-(char)probedWriteStuckFlow;
@end
