...
@interface FlowAnalyticsEngine : AnalyticsEngineCore {
	...
	char rollingLiveUsageSupported;
	...
	BOOL isScreenDark;
	unsigned usageCoalescingSpanSecs;
	unsigned usageWindowUnitsCount;
	char thresholdedFlowCount;
...
-(void)_reportThresholdedFlowCount:(unsigned)arg1 ;
-(BOOL)_properties:(id)arg1 toBundleID:(id*)arg2 procName:(id*)arg3 delegateName:(id*)arg4 ;
-(void)_logExcessCellUsage:(long long)arg1 properties:(id)arg2 closed:(BOOL)arg3 ;
...
-(char)_persistUuidBundleIDMap:(id)arg1 ;
-(void)_removeAllInfoForProcess:(id)arg1 withUUID:(id)arg2 ;
-(char)_verifyUuidBundleIDMapIntegrity:(id)arg1 ;
