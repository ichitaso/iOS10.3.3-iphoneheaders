...
+(id)epochWithPrimaryKey:(id)arg1 interfaceName:(id)arg2 isCell:(BOOL)arg3 maxBars:(int)arg4 roamingEvent:(BOOL)arg5 roamingAttrs:(id)arg6 supportsIPv4:(char)arg7 supportsIPv6:(char)arg8 inWorkspace:(id)arg9 andQueue:(id)arg10 ;
...
-(int)getMatchingRTLocationOfInterestType;
-(StopWatch *)fatal;
...
-(BOOL)matchesLOI:(int)arg1 ;
-(id)_initWithPrimaryKey:(id)arg1 interfaceName:(id)arg2 isCell:(BOOL)arg3 maxBars:(int)arg4 roamingEvent:(BOOL)arg5 roamingAttrs:(id)arg6 supportsIPv4:(char)arg7 supportsIPv6:(char)arg8 inWorkspace:(id)arg9 andQueue:(id)arg10 ;
