...
-(void)_postLinkQualityChangeNotification:(id)arg1 info:(id)arg2 ;
...
-(BOOL)_writeJournalRecord:(SCD_Struct_Ne15*)arg1 fromCellFingerprint:(BOOL)arg2 key:(const char*)arg3 atLOI:(int)arg4 ofKind:(id)arg5 lqm:(int)arg6 isFaulty:(unsigned)arg7 ;
