...
-(id)folderIdsForPersistentPushForDataclasses:(int)arg1 clientID:(id)arg2 ;
-(id)defaultContactsFolder;
-(id)defaultEventsFolder;
-(id)defaultToDosFolder;
-(id)defaultNotesFolder;
-(void)_getContextElementsForItemChangeType:(unsigned)arg1 dataclass:(int)arg2 nativeContext:(id)arg3 outContext:(id*)arg4 outServerId:(id*)arg5 ;
...
-(char)_submitAutoDV2TaskForEmailAddress:(id)arg1 withConsumer:(id)arg2 ;
...
-(char)setFolderIdsForPersistentPushAdded:(id)arg1 deleted:(id)arg2 clientID:(id)arg3 ;
-(char)clearFolderIdsForPersistentPushWithClientID:(id)arg1 ;
...
-(char)autodiscoverOAuthAccountWithConsumer:(id)arg1 ;
-(void)autodiscoverV2Task:(id)arg1 completedWithStatus:(int)arg2 authorizationURI:(id)arg3 easEndPoint:(id)arg4 error:(id)arg5 ;
