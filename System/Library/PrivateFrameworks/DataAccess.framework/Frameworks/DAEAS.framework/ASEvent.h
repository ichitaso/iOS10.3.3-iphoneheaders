...
@property (assign,nonatomic) char doNotSendBody;                                       //@synthesize doNotSendBody=_doNotSendBody - In the implementation block
...
-(int)_meetingResponseShouldUseEmail:(char)arg1 shouldFilterForEmail:(char)arg2 ;
-(NSDate *)dTStamp;
...
-(char)saveServerIDAndUidToCalendar;
...
-(char)setCalEventWithExistingRecord:(void*)arg1 intoCalendar:(void*)arg2 ;
...
-(void)setDoNotSendBody:(char)arg1 ;
