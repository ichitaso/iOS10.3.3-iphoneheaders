...
-(char)_loadAttributesFromCalRecurrence:(void*)arg1 parentStartDate:(id)arg2 parentItem:(id)arg3 useFloatingTimeForAllDayEvents:(char)arg4 ;
-(void*)_newRecurrenceWithParentStartDate:(id)arg1 useFloatingTimeForAllDayEvents:(char)arg2 ;
...
-(id)initWithCalRecurrence:(void*)arg1 parentEvent:(id)arg2 useFloatingTimeForAllDayEvents:(char)arg3 ;
-(void)saveToCalendarWithParentASEvent:(id)arg1 existingRecord:(void*)arg2 shouldMergeProperties:(char)arg3 outMergeDidChooseLocalProperties:(char*)arg4 useFloatingTimeForAllDayEvents:(char)arg5 ;
