...
-(void)monitorFoldersForUpdates:(id)arg1 persistent:(char)arg2 ;
...
-(void)_retryMonitoringWithRetryCount:(id)arg1 persistent:(char)arg2 ;
-(void)_monitorFoldersForUpdates:(id)arg1 persistent:(char)arg2 sequentialRetryCount:(int)arg3 ;
