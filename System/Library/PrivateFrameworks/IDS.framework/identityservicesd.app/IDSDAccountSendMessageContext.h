...
@interface IDSDAccountSendMessageContext : NSObject {
	...
	char _silentlyFailMessagesOnSwitch;
	char _shouldProtectTrafficUsingClassA;
	char _shouldAllowCloudDelivery;
...
@property (assign,nonatomic) char silentlyFailMessagesOnSwitch;                               //@synthesize silentlyFailMessagesOnSwitch=_silentlyFailMessagesOnSwitch - In the implementation block
@property (assign,nonatomic) char shouldProtectTrafficUsingClassA;                            //@synthesize shouldProtectTrafficUsingClassA=_shouldProtectTrafficUsingClassA - In the implementation block
@property (assign,nonatomic) char shouldAllowCloudDelivery;                                   //@synthesize shouldAllowCloudDelivery=_shouldAllowCloudDelivery - In the implementation block
...
-(char)silentlyFailMessagesOnSwitch;
-(void)setSilentlyFailMessagesOnSwitch:(char)arg1 ;
-(char)shouldProtectTrafficUsingClassA;
-(void)setShouldProtectTrafficUsingClassA:(char)arg1 ;
-(char)shouldAllowCloudDelivery;
-(void)setShouldAllowCloudDelivery:(char)arg1 ;
