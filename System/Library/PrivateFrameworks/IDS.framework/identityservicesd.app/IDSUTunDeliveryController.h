...
-(void)removeUTunPeerWithSessionID:(id)arg1 reason:(int)arg2 ;
...
-(void)removeUTunPeerWithDeviceUniqueID:(id)arg1 btuuid:(id)arg2 reason:(int)arg3 ;
...
-(char)hasSpaceForCloudMessagesWithPriority:(int)arg1 dataProtectionClass:(unsigned)arg2 ;
