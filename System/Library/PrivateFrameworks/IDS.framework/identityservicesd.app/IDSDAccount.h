...
@property (assign,nonatomic) char pendingDependantCheck;                                       //@synthesize pendingDependantCheck=_pendingDependantCheck - In the implementation block
...
-(char)pendingDependantCheck;
-(void)setPendingDependantCheck:(char)arg1 ;
