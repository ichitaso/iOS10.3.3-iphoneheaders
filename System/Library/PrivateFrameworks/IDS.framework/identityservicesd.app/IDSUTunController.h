...
-(unsigned)onTransportThread_SendToGlobalLinkWithSessionID:(id)arg1 packetBuffer:(SCD_Struct_ID11*)arg2 ;
...
-(unsigned char)handleUtunChannelWrite:(id)arg1 source:(sockaddr*)arg2 destination:(sockaddr*)arg3 upperProtocol:(unsigned char)arg4 bytes:(const void*)arg5 bytesLen:(unsigned long)arg6 ;
-(void)handleIPPayload:(const void*)arg1 bytesLength:(unsigned long)arg2 source:(sockaddr*)arg3 destination:(sockaddr*)arg4 upperProtocol:(unsigned char)arg5 forDeviceConnectionInfo:(id)arg6 flush:(char)arg7 callerShouldStop:(char*)arg8 ;
...
-(char)handleIncomingPacket:(SCD_Struct_ID11*)arg1 fromDeviceToken:(id)arg2 ;
