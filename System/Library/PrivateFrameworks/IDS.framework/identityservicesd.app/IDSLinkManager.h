...
@interface IDSLinkManager : NSObject <IDSLinkDelegate, IDSBTLinkManagerDelegate, IDSWPLinkManagerDelegate, IMSystemMonitorListener, IDSCellularLinkDelegate> {
	...
	char _isGlobalLinkBroughtUp;
	char _shouldStartAllocation;
	char _delayedGlobalLinkBringUp;
	void* _wifiManager;
	void* _wifiDevice;
...
-(id)_newUDPLinkForDeviceUniqueID:(id)arg1 cbuuid:(id)arg2 IPVersion:(unsigned)arg3 port:(unsigned short)arg4 ;
...
-(void)_suspendBTLink:(char)arg1 cbuuid:(id)arg2 ;
...
-(unsigned)_sendPacketBuffer:(SCD_Struct_ID11*)arg1 toDeviceUniqueID:(id)arg2 cbuuid:(id)arg3 link:(id)arg4 ;
...
-(void)flushBuffer:(unsigned)arg1 toDeviceUniqueID:(id)arg2 cbuuid:(id)arg3 ;
...
-(void)currentLinkType:(unsigned*)arg1 andRATType:(unsigned*)arg2 forDeviceID:(id)arg3 ;
