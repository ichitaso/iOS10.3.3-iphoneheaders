...
@interface IDSLocalDeliveryMessage : NSObject {
	...
	char _bypassDuet;
	unsigned _minCompatibilityVersion;
...
@property (assign,nonatomic) unsigned minCompatibilityVersion;                                //@synthesize minCompatibilityVersion=_minCompatibilityVersion - In the implementation block
...
+(id)socketPairMessageWithCommand:(int)arg1 streamID:(unsigned short)arg2 sequenceNumber:(unsigned)arg3 messageID:(unsigned)arg4 expectsPeerResponse:(char)arg5 wantsAppAck:(char)arg6 compressPayload:(char)arg7 compressed:(char)arg8 peerResponseIdentifier:(id)arg9 messageUUID:(id)arg10 payload:(id)arg11 protobuf:(id)arg12 resourcePath:(id)arg13 resourceMetadata:(id)arg14 expiryDate:(id)arg15 ;
...
-(void)setMinCompatibilityVersion:(unsigned)arg1 ;
