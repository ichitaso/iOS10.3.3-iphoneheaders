...
@interface OKProducerManager : NSObject {
	...
	int _minimumNetworkStatusForDownloads;
...
@property (assign,nonatomic) int minimumNetworkStatusForDownloads;              //@synthesize minimumNetworkStatusForDownloads=_minimumNetworkStatusForDownloads - In the implementation block
+(id)defaultManager;
-(id)init;
-(void)dealloc;
...
-(char)hasInstalledPluginAndContentWithIdentifier:(id)arg1 ;
...
-(void)createDocumentAtFileURL:(id)arg1 withPluginIdentifier:(id)arg2 guidelines:(id)arg3 mediaURLs:(id)arg4 mediaItemLookupDelegate:(id)arg5 flattenMedia:(char)arg6 flattenProducer:(char)arg7 prepareCaches:(char)arg8 format:(unsigned)arg9 keepOpen:(char)arg10 documentClass:(Class)arg11 progressBlock:(/*^block*/id)arg12 completionBlock:(/*^block*/id)arg13 ;
...
-(id)installedPluginsWithFamily:(unsigned)arg1 ;
-(id)loadedPlugins;
-(id)loadedContents;
...
-(int)minimumNetworkStatusForDownloads;
-(void)setMinimumNetworkStatusForDownloads:(int)arg1 ;
@end
