...
@interface OKPresentationInfo : NSObject {
	...
	char _renderTimeLoggingSupported;
...
@property (assign) char renderTimeLoggingSupported;                      //@synthesize renderTimeLoggingSupported=_renderTimeLoggingSupported - In the implementation block
...
-(char)renderTimeLoggingSupported;
-(void)setRenderTimeLoggingSupported:(char)arg1 ;
