...
+(id)valueForObject:(id)arg1 ofType:(unsigned)arg2 optionalSubType:(unsigned)arg3 optionalClass:(Class)arg4 optionalMapping:(id)arg5 resolution:(id)arg6 ;
+(id)valueForKey:(id)arg1 ofType:(unsigned)arg2 settings:(id)arg3 optionalSubType:(unsigned)arg4 optionalClass:(Class)arg5 optionalMapping:(id)arg6 resolution:(id)arg7 ;
...
+(id)arrayFromObject:(id)arg1 type:(unsigned)arg2 ;
...
+(id)dictionaryFromObject:(id)arg1 type:(unsigned)arg2 ;
