...
@property (nonatomic,readonly) char isDisplay;                                                            //@synthesize isDisplay=_isDisplay - In the implementation block
...
-(void)animateSynopsisViewBlurForDisplay:(char)arg1 withProgress:(float)arg2 ;
...
-(void)prepareAdjacentItemWidgetViews:(unsigned)arg1 ;
