...
@property (assign,nonatomic) unsigned backgroundRecordingID;                          //@synthesize backgroundRecordingID=_backgroundRecordingID - In the implementation block
...
-(id)_audioDevice;
-(id)_tempFileURL;
-(void)setBackgroundRecordingID:(unsigned)arg1 ;
...
-(char)openSession;
-(unsigned)micCount;
-(unsigned)backgroundRecordingID;
