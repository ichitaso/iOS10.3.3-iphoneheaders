...
+(char)localeIsAutoUpdating:(CFLocaleRef)arg1 ;
+(id)applicationLocale;
+(unsigned)autoupdatingCurrentLocaleChangeCount;
+(id)cacheKeyForCFLocale:(CFLocaleRef)arg1 ;
+(void)initialize;
+(id)currentLocale;
...
-(id)initWithLocale:(id)arg1 documentLanguageIdentifier:(id)arg2 useAutoupdating:(char)arg3 ;
