...
+(CFStringRef)createTableAttachmentIdWithNumber:(long)arg1 ;
...
+(id)mapBaseFillStyleForRowIndex:(unsigned short)arg1 columnIndex:(unsigned short)arg2 state:(id)arg3 isGroupingCell:(char)arg4 ;
+(const char*)name;
@end
