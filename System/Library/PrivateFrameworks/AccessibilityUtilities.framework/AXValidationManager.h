...
-(char)client:(id)arg1 validateClass:(id)arg2 hasInstanceVariable:(id)arg3 withType:(const char*)arg4 ;
...
-(char)_client:(id)arg1 validateClass:(id)arg2 hasClassMethod:(id)arg3 withFullSignature:(const char*)arg4 argList:(void*)arg5 ;
-(char)_client:(id)arg1 validateClass:(id)arg2 hasMethod:(id)arg3 methodType:(int)arg4 returnType:(id)arg5 arguments:(id)arg6 ;
-(char)client:(id)arg1 validateClass:(id)arg2 hasInstanceMethod:(id)arg3 withFullSignature:(const char*)arg4 argList:(void*)arg5 ;
...
-(char)client:(id)arg1 validateClass:(id)arg2 hasProperty:(id)arg3 withType:(const char*)arg4 ;
...
-(char)client:(id)arg1 validateProtocol:(id)arg2 conformsToProtocol:(id)arg3 ;
...
-(char)validateClass:(id)arg1 hasInstanceVariable:(id)arg2 withType:(const char*)arg3 ;
-(char)validateClass:(id)arg1 hasClassMethod:(id)arg2 withFullSignature:(const char*)arg3 ;
-(char)client:(id)arg1 validateClass:(id)arg2 hasClassMethod:(id)arg3 withFullSignature:(const char*)arg4 ;
-(char)client:(id)arg1 validateClass:(id)arg2 hasInstanceMethod:(id)arg3 withFullSignature:(const char*)arg4 ;
-(char)validateClass:(id)arg1 hasInstanceMethod:(id)arg2 withFullSignature:(const char*)arg3 ;
...
-(char)validateClass:(id)arg1 hasProperty:(id)arg2 withType:(const char*)arg3 ;
-(char)validateClass:(id)arg1 conformsToProtocol:(id)arg2 ;
-(char)validateProtocol:(id)arg1 conformsToProtocol:(id)arg2 ;
