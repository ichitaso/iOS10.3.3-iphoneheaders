...
@property (assign,nonatomic) unsigned HIDEventFilterMask;                                          //@synthesize HIDEventFilterMask=_HIDEventFilterMask - In the implementation block
...
-(void)setHIDEventFilterMask:(unsigned)arg1 ;
