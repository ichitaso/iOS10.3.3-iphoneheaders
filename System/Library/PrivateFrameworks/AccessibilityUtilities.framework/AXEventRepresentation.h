...
@property (assign,nonatomic) char isDisplayIntegrated;                                                  //@synthesize isDisplayIntegrated=_isDisplayIntegrated - In the implementation block
...
@property (nonatomic,readonly) char willBeUpdated; 
...
@property (assign,getter=isRedirectEvent,nonatomic) char redirectEvent;                                 //@synthesize redirectEvent=_redirectEvent - In the implementation block
...
-(void)setIsDisplayIntegrated:(char)arg1 ;
...
-(char)isRedirectEvent;
-(void)setRedirectEvent:(char)arg1 ;
-(AXEventGameControllerInfoRepresentation *)gameControllerInfo;
-(id)_senderNameForID;
-(char)_HIDEventIsAccessibilityEvent:(IOHIDEventRef)arg1 ;
