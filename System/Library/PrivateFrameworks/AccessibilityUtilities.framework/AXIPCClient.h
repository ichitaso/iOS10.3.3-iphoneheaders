...
-(char)sendAsyncMessage:(id)arg1 replyOnQueue:(id)arg2 replyHandler:(/*^block*/id)arg3 ;
-(char)sendSimpleMessage:(id)arg1 withError:(id*)arg2 ;
-(char)sendAsyncMessage:(id)arg1 withReplyHandler:(/*^block*/id)arg2 ;
...
-(char)_handleErrorWithMessage:(id)arg1 machError:(int)arg2 outError:(id*)arg3 ;
-(char)_verifyConnectionWithError:(id*)arg1 ;
-(char)sendSimpleMessage:(id)arg1 synchronizationPort:(unsigned)arg2 error:(id*)arg3 ;
-(char)_prepareToSendMessage:(id)arg1 withError:(id*)arg2 prepSuccessHandler:(/*^block*/id)arg3 ;
