...
+(id)appBundleContainerWithIdentifier:(id)arg1 createIfNeeded:(char)arg2 created:(char*)arg3 error:(id*)arg4 ;
+(id)vpnPluginBundleContainerWithIdentifier:(id)arg1 createIfNeeded:(char)arg2 created:(char*)arg3 error:(id*)arg4 ;
+(id)pluginKitPluginBundleContainerWithIdentifier:(id)arg1 createIfNeeded:(char)arg2 created:(char*)arg3 error:(id*)arg4 ;
...
+(char)updateiTunesMetadataForAppWithIdentifier:(id)arg1 plistData:(id)arg2 error:(id*)arg3 ;
-(char)makeContainerLiveReplacingContainer:(id)arg1 reason:(unsigned)arg2 withError:(id*)arg3 ;
-(char)captureBundleByMoving:(id)arg1 withError:(id*)arg2 ;
