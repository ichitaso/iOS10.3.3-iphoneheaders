...
@interface _CDGenericInteractionRanker : NSObject <_CDInteractionRanking> {
	...
	unsigned _rankAggregationMethod;
...
@property (assign,nonatomic) unsigned rankAggregationMethod;              //@synthesize rankAggregationMethod=_rankAggregationMethod - In the implementation block
...
-(unsigned)rankAggregationMethod;
-(void)setRankAggregationMethod:(unsigned)arg1 ;
