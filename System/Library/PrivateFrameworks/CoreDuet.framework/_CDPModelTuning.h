...
+(void)_enumerateSubsetsOfSet:(unsigned*)arg1 setLength:(unsigned long)arg2 index:(unsigned long)arg3 subset:(unsigned*)arg4 subsetLength:(unsigned long)arg5 index:(unsigned long)arg6 callback:(/*^block*/id)arg7 ;
+(unsigned*)_newSetDifference:(unsigned*)arg1 setLength:(unsigned long)arg2 subset:(unsigned*)arg3 subsetLength:(unsigned long)arg4 ;
...
+(void)_enumerateSubsetsOfSet:(unsigned*)arg1 setLength:(unsigned long)arg2 withSize:(unsigned long)arg3 callback:(/*^block*/id)arg4 ;
+(/*^block*/id)f1Score;
+(/*^block*/id)f2Score;
