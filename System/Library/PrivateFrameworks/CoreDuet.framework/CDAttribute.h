...
-(id)_initWithSession:(id)arg1 name:(id)arg2 type:(int)arg3 integerId:(unsigned long long)arg4 weak:(char)arg5 error:(id*)arg6 ;
...
-(char)isBypassClientForValue:(id)arg1 ;
...
-(unsigned)meteringIsActive:(id)arg1 ;
