...
@class AXIPCServer, AXIPCClient, NSMutableArray, NSMapTable, _AXAssertionServer;
...
@interface _AXSpringBoardServerInstance : NSObject {
	...
	char _disableNotificationCenterAssertionHeld;
	char _disableControlCenterAssertionHeld;
...
@property (assign,nonatomic) char disableNotificationCenterAssertionHeld;                   //@synthesize disableNotificationCenterAssertionHeld=_disableNotificationCenterAssertionHeld - In the implementation block
@property (assign,nonatomic) char disableControlCenterAssertionHeld;                        //@synthesize disableControlCenterAssertionHeld=_disableControlCenterAssertionHeld - In the implementation block
...
-(char)disableNotificationCenterAssertionHeld;
-(char)disableControlCenterAssertionHeld;
...
-(void)setDisableNotificationCenterAssertionHeld:(char)arg1 ;
-(void)setDisableControlCenterAssertionHeld:(char)arg1 ;
-(void)_setDashboardSystemGesturesDisabled:(char)arg1 ;
-(char)_hasActionHandlerForClientPort:(unsigned)arg1 ;
-(void)_removeActionHandler:(unsigned)arg1 ;
-(char)_hasReachabilityHandlerForClientPort:(unsigned)arg1 ;
