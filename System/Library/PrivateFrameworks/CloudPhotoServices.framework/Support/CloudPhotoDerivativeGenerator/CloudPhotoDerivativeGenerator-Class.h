...
#import <CloudPhotoDerivativeGenerator/CloudPhotoDerivativeGeneratorProtocol.h>

@interface CloudPhotoDerivativeGenerator : NSObject <CloudPhotoDerivativeGeneratorProtocol>
+(CGSize)_targetSizeFromInputSize:(CGSize)arg1 maximumPixelCount:(int)arg2 ;
+(char)_canAccelerateJPEGDecodeForImageSize:(CGSize)arg1 ;
+(char)_resizeImageUsingHWForInputURL:(id)arg1 destinationURL:(id)arg2 maximumPixelCount:(int)arg3 error:(id*)arg4 ;
+(char)_resizeImageUsingSWForInputImageSource:(CGImageSourceRef)arg1 destinationURL:(id)arg2 targetSize:(CGSize)arg3 bakeInOrientation:(char)arg4 colorOutput:(int)arg5 error:(id*)arg6 ;
+(id)_metadataWithoutOrientation:(id)arg1 ;
+(char)_generateThumbnailsFromJPEGData:(id)arg1 inputSize:(CGSize)arg2 outputSize:(CGSize)arg3 outputJPEGData:(id*)arg4 ;
+(char)_rideTheUnicorn;
-(id)init;
