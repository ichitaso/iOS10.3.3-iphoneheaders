...
@interface FigCoreMotionDelegate : NSObject {
	...
	SCD_Struct_Fi52 fusedRingAccel[256];
	SCD_Struct_Fi53 fusedRingQuaternion[256];
	SCD_Struct_Fi52 fusedRingPosition[256];
	...
	SCD_Struct_Fi53 previousQuaternion;
	SCD_Struct_Fi53 currentQuaternion;
	char computingPosition;
	SCD_Struct_Fi58 position;
	SCD_Struct_Fi58 velocity;
...
-(void)didUpdatePositionWithAcceleration:(SCD_Struct_Fi52*)arg1 forTimeStamp:(double)arg2 ;
-(void)didUpdateVelocityWithAcceleration:(SCD_Struct_Fi52*)arg1 forTimeStamp:(double)arg2 ;
-(void)didUpdatePositionWithTimeStamp:(double)arg1 ;
-(void)getCurrentDeltaQuaternion:(SCD_Struct_Fi53*)arg1 ;
-(void)updateDeviceCallback:(char)arg1 fusedMotionUpdateInterval:(float)arg2 ;
-(void)updateGyroInterval:(float)arg1 ;
-(void)didUpdateAcceleration:(SCD_Struct_Fi52)arg1 time:(double)arg2 ;
-(void)didUpdateGravity:(SCD_Struct_Fi52)arg1 time:(double)arg2 ;
...
-(void)didUpdateFusedMotionWithDeviceMotion:(SCD_Struct_Fi59)arg1 time:(double)arg2 ifsync:(char)arg3 ;
...
-(void)getCurrentQuaternion:(SCD_Struct_Fi53*)arg1 ;
