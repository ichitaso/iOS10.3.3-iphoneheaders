...
-(int)_indexOfTime:(SCD_Struct_BW2)arg1 ;
-(SCD_Struct_BW2)_originalDurationForVideoBufferWithTime:(SCD_Struct_BW2)arg1 ;
-(void)_adjustTimesInAudioInterleavingQueues;
-(void)enqueueVideoBufferTime:(SCD_Struct_BW2)arg1 nativeTime:(SCD_Struct_BW2)arg2 isBracketFrame:(char)arg3 isSISFrame:(char)arg4 ;
-(void)enqueueSampleBuffer:(opaqueCMSampleBufferRef)arg1 forMediaTypeWithIndex:(int)arg2 ;
-(SCD_Struct_BW2)audioOffsetForOriginalStillImageTime:(SCD_Struct_BW2)arg1 ;
-(opaqueCMSampleBufferRef)dequeueAndRetainAdjustedSampleBufferForMediaTypeWithIndex:(int)arg1 ;
