...
@property (nonatomic,retain) APSConnection * prodAPSConnection;                           //@synthesize prodAPSConnection=_prodAPSConnection - In the implementation block
@property (nonatomic,retain) APSConnection * devAPSConnection;                            //@synthesize devAPSConnection=_devAPSConnection - In the implementation block
...
-(void)setProdAPSConnection:(APSConnection *)arg1 ;
-(APSConnection *)devAPSConnection;
-(void)setDevAPSConnection:(APSConnection *)arg1 ;
...
-(char)isPersonIDAllowedToDownloadAssets:(id)arg1 ;
