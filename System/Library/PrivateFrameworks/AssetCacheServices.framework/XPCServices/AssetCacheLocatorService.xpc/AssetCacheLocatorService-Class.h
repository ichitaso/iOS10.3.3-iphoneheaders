...
@class NSURL, NSString, NSArray, NSDictionary, ACLSTypeVerifier, NSDate, NSURLSessionConfiguration, NSObject, NSMutableDictionary, NSOperationQueue, NSURLSession, NSMutableData;

@interface AssetCacheLocatorService : NSObject <NSURLSessionDataDelegate> {
	...
	NSDictionary* _serverCapabilitiesTemplate;
	ACLSTypeVerifier* _serverCapabilitiesVerifier;
	NSDictionary* _serverDetailsTemplate;
	ACLSTypeVerifier* _serverDetailsVerifier;
	NSDictionary* _diskCacheTemplate;
	ACLSTypeVerifier* _diskCacheVerifier;
	NSArray* _softwareVersions;
	NSDate* _bootTime;
	NSURLSessionConfiguration* _locateSessionConfig;
...
@property (assign) char redactLogs;                                                  //@synthesize redactLogs=_redactLogs - In the implementation block
...
@property (retain) NSDictionary * serverCapabilitiesTemplate;                        //@synthesize serverCapabilitiesTemplate=_serverCapabilitiesTemplate - In the implementation block
@property (retain) ACLSTypeVerifier * serverCapabilitiesVerifier;                    //@synthesize serverCapabilitiesVerifier=_serverCapabilitiesVerifier - In the implementation block
...
@property (retain) ACLSTypeVerifier * serverDetailsVerifier;                         //@synthesize serverDetailsVerifier=_serverDetailsVerifier - In the implementation block
...
@property (retain) ACLSTypeVerifier * diskCacheVerifier;                             //@synthesize diskCacheVerifier=_diskCacheVerifier - In the implementation block
...
@property (retain) NSURLSessionConfiguration * locateSessionConfig;                  //@synthesize locateSessionConfig=_locateSessionConfig - In the implementation block
...
@property (assign) unsigned long long testFlags;                                     //@synthesize testFlags=_testFlags - In the implementation block
...
@property (retain) NSURLSession * locateSession;                                     //@synthesize locateSession=_locateSession - In the implementation block
...
@property (retain) NSDate * lastLocateDate;                                          //@synthesize lastLocateDate=_lastLocateDate - In the implementation block
@property (readonly) unsigned hash; 
@property (readonly) Class superclass; 
@property (copy,readonly) NSString * description; 
@property (copy,readonly) NSString * debugDescription; 
-(char)makeLocalAddresses:(id*)arg1 andGatewayIdentifiers:(id*)arg2 tag:(unsigned)arg3 ;
-(id)systemGroupContainerPathWithGroupIdentifier:(id)arg1 ;
...
-(NSURL *)locateURL;
-(void)setRedactLogs:(char)arg1 ;
-(void)setSkipEVCheck:(char)arg1 ;
-(void)setDiskCachePlistPath:(NSString *)arg1 ;
-(void)setLocalhostAddresses:(NSArray *)arg1 ;
-(void)setServerCapabilitiesTemplate:(NSDictionary *)arg1 ;
-(NSDictionary *)serverCapabilitiesTemplate;
-(void)setServerCapabilitiesVerifier:(ACLSTypeVerifier *)arg1 ;
-(void)setServerDetailsTemplate:(NSDictionary *)arg1 ;
-(NSDictionary *)serverDetailsTemplate;
-(void)setServerDetailsVerifier:(ACLSTypeVerifier *)arg1 ;
-(void)setDiskCacheTemplate:(NSDictionary *)arg1 ;
-(NSDictionary *)diskCacheTemplate;
-(void)setDiskCacheVerifier:(ACLSTypeVerifier *)arg1 ;
...
-(void)setLocateSessionConfig:(NSURLSessionConfiguration *)arg1 ;
...
-(id)NSObjectFromXPCObject:(id)arg1 tag:(unsigned)arg2 ;
-(id)XPCObjectFromNSObject:(id)arg1 tag:(unsigned)arg2 ;
-(id)servers:(id)arg1 byAppendingServers:(id)arg2 ;
-(id)redactObject:(id)arg1 ;
...
-(char)doesConnection:(id)arg1 haveEntitlement:(const char*)arg2 ;
...
-(char)handleIntrospectEvent:(id)arg1 forConnection:(id)arg2 tag:(unsigned)arg3 ;
-(char)handleSetTestFlagsEvent:(id)arg1 forConnection:(id)arg2 tag:(unsigned)arg3 ;
-(id)choose:(int)arg1 fromArray:(id)arg2 sorted:(char)arg3 other:(id)arg4 tag:(unsigned)arg5 ;
-(id)objectWithError:(id)arg1 ;
-(void)relocateCachingServersWithTimeout:(double)arg1 capabilities:(id)arg2 affinityID:(id)arg3 forceRefresh:(char)arg4 tag:(unsigned)arg5 ;
-(void)locateCachingServersWithTimeout:(double)arg1 capabilities:(id)arg2 affinityID:(id)arg3 autoRefresh:(char)arg4 quickMiss:(char)arg5 forceMiss:(char)arg6 callback:(/*^block*/id)arg7 callbackQueue:(id)arg8 tag:(unsigned)arg9 ;
-(void)recentlySeenCachingServerWithAutoRefresh:(char)arg1 callback:(/*^block*/id)arg2 callbackQueue:(id)arg3 tag:(unsigned)arg4 ;
-(void)importToCachingServerAsURL:(id)arg1 sourcePath:(id)arg2 sourceFileHandle:(id)arg3 sourceOffset:(long long)arg4 sourceLength:(long long)arg5 method:(id)arg6 headers:(id)arg7 importStrategies:(id)arg8 entitled:(char)arg9 callback:(/*^block*/id)arg10 callbackQueue:(id)arg11 tag:(unsigned)arg12 ;
...
-(void)resolveDNSPublicAddressRangesFromRecordNamed:(id)arg1 withTimeout:(double)arg2 errorIfNotFound:(char)arg3 callback:(/*^block*/id)arg4 callbackQueue:(id)arg5 tag:(unsigned)arg6 ;
...
-(id)cachedEntryCalled:(id)arg1 withKey:(id)arg2 forNetworkIdentifiers:(id)arg3 validityInterval:(double*)arg4 tag:(unsigned)arg5 ;
-(void)uncacheEntriesCalled:(id)arg1 withKey:(id)arg2 forNetworkIdentifiers:(id)arg3 tag:(unsigned)arg4 ;
-(void)cachedRecentlySeen:(id*)arg1 forNetworkIdentifiers:(id)arg2 validityInterval:(double*)arg3 tag:(unsigned)arg4 ;
...
-(ACLSTypeVerifier *)serverCapabilitiesVerifier;
-(id)locateCallback;
-(NSURLSession *)locateSession;
...
-(void)setLocateSession:(NSURLSession *)arg1 ;
-(void)setLocateServerValidated:(char)arg1 ;
-(ACLSTypeVerifier *)serverDetailsVerifier;
...
-(void)cachedServers:(id*)arg1 forNetworkIdentifiers:(id)arg2 validityInterval:(double*)arg3 tag:(unsigned)arg4 ;
-(NSArray *)localhostAddresses;
-(char)probeCacheForType:(id)arg1 withLabel:(id)arg2 networkIdentifiers:(id)arg3 hitServers:(id*)arg4 hitValidityInterval:(double*)arg5 tag:(unsigned)arg6 ;
-(void)refineServers:(id)arg1 intoBest:(id*)arg2 andOther:(id*)arg3 tag:(unsigned)arg4 ;
-(id)serversFromArray:(id)arg1 withCapabilities:(id)arg2 tag:(unsigned)arg3 ;
-(id)describeCapableServers:(id)arg1 fromAvailableServers:(id)arg2 withOtherServers:(id)arg3 ;
-(id)cachedServersForAffinityID:(id)arg1 tag:(unsigned)arg2 ;
-(NSDate *)lastLocateDate;
-(int)probeCacheWithLabel:(id)arg1 capabilities:(id)arg2 affinityID:(id)arg3 hitServers:(id*)arg4 hitServersAreSorted:(char*)arg5 hitOtherServers:(id*)arg6 hitValidityInterval:(double*)arg7 tag:(unsigned)arg8 ;
...
-(void)cacheServers:(id)arg1 forAffinityID:(id)arg2 tag:(unsigned)arg3 ;
-(void)queryServersFromArray:(id)arg1 forAffinityID:(id)arg2 withTimeout:(double)arg3 callbackWithServers:(/*^block*/id)arg4 callbackQueue:(id)arg5 tag:(unsigned)arg6 ;
...
-(void)uncacheAllRecentlySeenWithTag:(unsigned)arg1 ;
...
-(id)locateTetheredCachingServersWithTag:(unsigned)arg1 ;
...
-(void)importToLocalCachingServerAsURL:(id)arg1 sourceFileHandle:(id)arg2 sourceOffset:(long long)arg3 sourceLength:(long long)arg4 method:(id)arg5 headers:(id)arg6 callback:(/*^block*/id)arg7 callbackQueue:(id)arg8 tag:(unsigned)arg9 ;
-(unsigned)locateTag;
-(char)skipEVCheck;
...
-(void)setLastLocateDate:(NSDate *)arg1 ;
-(char)parseLocateResponse:(id)arg1 intoServers:(id*)arg2 validityInterval:(double*)arg3 error:(id*)arg4 tag:(unsigned)arg5 ;
-(char)redactLogs;
-(id)redactStringsFromObject:(id)arg1 usingBlock:(/*^block*/id)arg2 ;
-(id)errorWithObject:(id)arg1 fromService:(const char*)arg2 tag:(unsigned)arg3 ;
