...
@property (nonatomic,readonly) unsigned firstUnlaidCharacterIndex; 
@property (nonatomic,readonly) unsigned firstUnlaidGlyphIndex; 
...
-(void)_showAttachmentCell:(id)arg1 inRect:(CGRect)arg2 characterIndex:(unsigned)arg3 ;
...
-(unsigned short)CGGlyphAtIndex:(unsigned)arg1 isValidIndex:(char*)arg2 ;
-(unsigned short)CGGlyphAtIndex:(unsigned)arg1 ;
...
-(id)linkAttributesForLink:(id)arg1 forCharacterAtIndex:(unsigned)arg2 ;
