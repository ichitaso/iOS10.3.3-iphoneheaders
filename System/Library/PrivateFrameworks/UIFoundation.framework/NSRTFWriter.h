...
-(void)writeFont:(id)arg1 forceFontNumber:(char)arg2 ;
-(void)writeKern:(id)arg1 ;
-(void)writeBaselineOffset:(id)arg1 ;
-(void)writeSuperscript:(id)arg1 ;
-(void)writeUnderlineStyle:(id)arg1 allowStrikethrough:(char)arg2 ;
...
-(char)writeCellTerminator:(id)arg1 atIndex:(unsigned)arg2 nestingLevel:(unsigned)arg3 ;
-(void)restoreAttributes:(id)arg1 ;
-(void)writeAttachment:(id)arg1 editableData:(id)arg2 editableTypeIdentifier:(id)arg3 ;
-(void)_setPreserveNaturalAlignment:(char)arg1 ;
-(void)dealloc;
