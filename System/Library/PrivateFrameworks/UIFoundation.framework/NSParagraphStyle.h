...
-(char)_isSuitableForFastStringDrawingWithAlignment:(int*)arg1 mirrorsTextAlignment:(char)arg2 lineBreakMode:(int*)arg3 tighteningFactorForTruncation:(float*)arg4 ;
-(id)init;
