...
-(void)MSASModel:(id)arg1 didFinishMarkingAsSpamInvitation:(id)arg2 info:(id)arg3 error:(id)arg4;
-(void)MSASModel:(id)arg1 didFinishMarkingAsSpamInvitationWithToken:(id)arg2 info:(id)arg3 error:(id)arg4;
...
-(void)MSASModel:(id)arg1 didMarkAssetCollection:(id)arg2 asHavingUnreadComments:(char)arg3 inAlbum:(id)arg4 info:(id)arg5;
-(void)MSASModel:(id)arg1 didMarkAssetCollection:(id)arg2 asHavingUnreadComments:(char)arg3 inAlbum:(id)arg4;
-(void)MSASModel:(id)arg1 didMarkAlbum:(id)arg2 asHavingUnreadContent:(char)arg3 info:(id)arg4;
