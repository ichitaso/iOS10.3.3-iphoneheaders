...
@class UICollectionView, UICollectionViewFlowLayout, NSArray, UIImage, MKMapView, SiriUIMapDetailsContainerView, MKPointAnnotation, SAMovieV2ShowtimeSnippet, NSString;
