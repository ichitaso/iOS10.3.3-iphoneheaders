...
-(id)_axElements;
-(int)_axTrackingMode;
-(CGPoint)accessibilityConvertCoordinateToWindow:(SCD_Struct_VK2)arg1 ;
...
-(SCD_Struct_VK2)_axConvertScreenPointToCoordinate:(CGPoint)arg1 ;
...
-(SCD_Struct_VK2)accessibilityCenter;
...
-(id)initWithGlobe:(char)arg1 shouldRasterize:(char)arg2 inBackground:(char)arg3 manifestConfiguration:(id)arg4 contentScale:(float)arg5 ;
