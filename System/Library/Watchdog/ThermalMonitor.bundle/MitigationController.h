...
-(void)setDieTempControllerProperty:(CFStringRef)arg1 level:(int)arg2 scaleToFixedPoint:(char)arg3 ;
-(void)setMaxAAPCPerfState:(CFStringRef)arg1 level:(int)arg2 ;
-(void)setMaxGraphicsDriverPerfState:(int)arg1 ;
-(int)setServiceProperty:(unsigned)arg1 key:(CFStringRef)arg2 value:(int)arg3 scaleToFixedPoint:(char)arg4 ;
-(int)DVD1Level;
-(int)DVB1Level;
-(int)SGXLevel;
-(int)powerSaveToken;
