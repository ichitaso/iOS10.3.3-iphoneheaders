...
-(id)_metricSpecifiersForSettingSection:(unsigned)arg1 ;
-(id)_specifierForMetricType:(unsigned)arg1 ;
-(void)setMetricEnabled:(id)arg1 forSpecifier:(id)arg2 ;
-(id)_metricServerConnection;
-(id)metricEnabledForSpecifier:(id)arg1 ;
-(void)setMetricEnabled:(char)arg1 forSpecifier:(id)arg2 autoMove:(char)arg3 ;
-(void)_logMetricChangeEventForSpecifier:(id)arg1 enabled:(char)arg2 ;
