...
@property (assign,nonatomic) char datasourceIsFromMe;                                    //@synthesize datasourceIsFromMe=_datasourceIsFromMe - In the implementation block
+(id)_sharedRenderQueue;
+(void)_writeThumbnailOfHandwriting:(id)arg1 atSize:(CGSize)arg2 useHighFidelityInk:(char)arg3 toDiskWithCompletionHandler:(/*^block*/id)arg4 ;
-(void)setBalloonPluginDatasource:(HWBalloonDataSource *)arg1 ;
-(void)cancelPlayback;
-(void)setDatasourceIsFromMe:(char)arg1 ;
-(HWBalloonDataSource *)balloonPluginDatasource;
-(char)datasourceIsFromMe;
