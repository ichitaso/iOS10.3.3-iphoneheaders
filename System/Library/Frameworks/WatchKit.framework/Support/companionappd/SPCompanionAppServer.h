...
@class NSObject, NSXPCListener, NSMutableDictionary, NRDevice, SPUsageTrack, BKSProcessAssertion, NSString, NSDictionary, NSDate;
...
@interface SPCompanionAppServer : NSObject <NSXPCListenerDelegate, SPLocalServerProtocol, SPDaemonManagerTransactionObserver, SPTransportDelegate, SPCompanionAppServerProtocol> {
	...
	/*^block*/id _launchSockPuppetAppCompletion;
...
@property (nonatomic,retain) NSString * launchSockPuppetAppCompanionAppIdentifer;                                  //@synthesize launchSockPuppetAppCompanionAppIdentifer=_launchSockPuppetAppCompanionAppIdentifer - In the implementation block
@property (nonatomic,retain) NSDictionary * launchSockPuppetAppOptions;                                            //@synthesize launchSockPuppetAppOptions=_launchSockPuppetAppOptions - In the implementation block
@property (nonatomic,copy) id launchSockPuppetAppCompletion;                                                       //@synthesize launchSockPuppetAppCompletion=_launchSockPuppetAppCompletion - In the implementation block
@property (nonatomic,retain) NSObject*<OS_dispatch_source> launchSockPuppetCancelLaunchTimer;                      //@synthesize launchSockPuppetCancelLaunchTimer=_launchSockPuppetCancelLaunchTimer - In the implementation block
...
-(void)sendPlist:(id)arg1 timeOut:(double)arg2 securityType:(int)arg3 ;
-(SPUsageTrack *)usageTrack;
-(char)_checkUnlockedSinceBoot;
-(char)_unlockedSinceBoot;
-(void)sendPlist:(id)arg1 securityType:(int)arg2 ;
-(NSMutableDictionary *)localConnections;
-(void)sendProtobuf:(id)arg1 sender:(id)arg2 timeOut:(double)arg3 securityType:(int)arg4 ;
...
-(void)_sockPuppetAppListUpdatedToLaunchSockPuppetAppForCompanionAppWithIdentifier:(id)arg1 options:(id)arg2 acxRetryGeneration:(unsigned)arg3 completion:(/*^block*/id)arg4 ;
...
-(void)extensionDidBeginSnapshotOrBackgroundGlanceUpdate:(id)arg1 ;
-(void)extensionDidEndSnapshotOrBackgroundGlanceUpdate:(id)arg1 ;
...
-(void)setLaunchSockPuppetAppCompanionAppIdentifer:(NSString *)arg1 ;
-(NSDictionary *)launchSockPuppetAppOptions;
-(void)setLaunchSockPuppetAppOptions:(NSDictionary *)arg1 ;
-(id)launchSockPuppetAppCompletion;
-(void)setLaunchSockPuppetAppCompletion:(id)arg1 ;
-(NSObject*<OS_dispatch_source>)launchSockPuppetCancelLaunchTimer;
-(void)setLaunchSockPuppetCancelLaunchTimer:(NSObject*<OS_dispatch_source>)arg1 ;
