...
@interface __NSURLBackgroundSession : __NSCFURLSession <NDBackgroundSessionClient, NSURLSessionSubclass> {
	...
	char _appWasLaunchedForBackgroundSessionSeen;
	int _notifyToken;
...
-(void)backgroundTask:(unsigned)arg1 didFinishCollectingMetrics:(id)arg2 reply:(/*^block*/id)arg3 ;
-(void)backgroundTask:(unsigned)arg1 didCompleteWithError:(id)arg2 info:(id)arg3 reply:(/*^block*/id)arg4 ;
...
-(void)backgroundAVAssetDownloadTask:(unsigned)arg1 didResolveMediaSelectionProperyList:(id)arg2 reply:(/*^block*/id)arg3 ;
...
-(void)setPropertyOnStreamWithIdentifier:(unsigned)arg1 propDict:(id)arg2 propKey:(id)arg3 ;
