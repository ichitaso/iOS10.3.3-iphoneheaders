...
@interface __NSCFURLLocalStreamTaskFromDataTask : __NSCFURLLocalStreamTask <SessionConnectionDelegate> {
	...
	char _myReadToHisWriteEOF;
	char _myReadToHisWriteSignaled;
	SCD_Struct_NS33 _myReadToHisWriteError;
	CFWriteStreamRef _myWriteToHisRead;
	char _myWriteToHisReadEOF;
	char _myWriteToHisReadSignaled;
	SCD_Struct_NS33 _myWriteToHisReadError;
