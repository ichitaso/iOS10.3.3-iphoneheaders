...
@interface __NSCFURLLocalStreamTask : NSURLSessionTask {
	...
	char _readSignaled;
	char _readEOF;
	SCD_Struct_NS33 _readError;
	NSData* _writeBuffer;
	char _writeSignaled;
	char _writeEOF;
	char _deliveredConnectionEstablished;
	SCD_Struct_NS33 _writeError;
...
-(void)_onqueue_readDataOfMinLength:(unsigned)arg1 maxLength:(unsigned)arg2 timeout:(double)arg3 completionHandler:(/*^block*/id)arg4 ;
-(void)_onqueue_captureStreams;
-(void)_onqueue_startSecureConnection;
-(void)_onqueue_stopSecureConnection;
-(void)_onqueue_dealWithSessionClientCertAuth:(int)arg1 credential:(id)arg2 completionHandler:(/*^block*/id)arg3 ;
-(char)_onqueue_processReadWork:(id)arg1 ;
-(char)_onqueue_processWriteWork:(id)arg1 ;
-(char)_onqueue_shufflePendingFor:(Class)arg1 ;
