...
#import <RPVideoEditorExtension/RPVideoEditorExtension-Structs.h>
...
@property (assign,getter=isExporting,nonatomic) char exporting;                                 //@synthesize exporting=_exporting - In the implementation block
...
@property (assign,getter=isPadMode,nonatomic) char padMode;                                     //@synthesize padMode=_padMode - In the implementation block
@property (assign,getter=isIntroMode,nonatomic) char introMode;                                 //@synthesize introMode=_introMode - In the implementation block
@property (assign,getter=isUIHidden,nonatomic) char uiHidden;                                   //@synthesize uiHidden=_uiHidden - In the implementation block
...
@property (assign) char hasEdit;                                                                //@synthesize hasEdit=_hasEdit - In the implementation block
...
-(id)initWithBundleIdentifier:(id)arg1 URL:(id)arg2 applicationName:(id)arg3 overrideTintColor:(id)arg4 ;
-(void)setActivityTypes:(NSMutableArray *)arg1 ;
-(void)setHasEdit:(char)arg1 ;
