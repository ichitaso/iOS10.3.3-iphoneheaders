...
@class NSMutableSet, UIEvent, NSArray, NSTimer, UIAlertView, UIStatusBar, UIStatusBarWindow, NSMutableArray, NSString, _UIIdleModeController, FBSDisplayLayoutMonitor, UIEventFetcher, UIEventDispatcher, UIColor, UIMoveEvent, NSMutableDictionary, NSMutableOrderedSet, UIWindow, UIRepeatedAction, UIApplicationSceneSettingsDiffInspector, BKSProcessAssertion, BKSAnimationFenceHandle, UISystemNavigationAction, UIActivityContinuationManager, UIGestureEnvironment, UIForceStageObservable, NSObject, _UIFeedbackEventBehavior, SBSApplicationShortcutService;
...
@interface UIApplication : UIResponder <FBSUIApplicationWorkspaceDelegate, FBSSceneDelegate, FBSUIApplicationSystemServiceDelegate, FBSDisplayLayoutObserver, UIAlertViewDelegate, UNRemoteNotificationRegistrarDelegate, UIActivityContinuationManagerApplicationContext, UIApplicationSnapshotPreparing> {
	...
	char optOutOfRTL;
	char _isDisplayingActivityContinuationUI;
...
@property (nonatomic,readonly) char supportsAlternateIcons; 
@property (nonatomic,readonly) NSString * alternateIconName; 
@property (assign,setter=_setIsDisplayingActivityContinuationUI:,getter=_isDisplayingActivityContinuationUI,nonatomic) char isDisplayingActivityContinuationUI;                    //@synthesize isDisplayingActivityContinuationUI=_isDisplayingActivityContinuationUI - In the implementation block
...
@property (getter=isIgnoringInteractionEvents,nonatomic,readonly) char ignoringInteractionEvents; 
...
-(char)_isDisplayingActivityContinuationUI;
-(void)_setIsDisplayingActivityContinuationUI:(char)arg1 ;
...
-(void)_updateForcedStatusBarForegroundTransparentWithContext:(const SCD_Struct_UI3*)arg1 ;
...
-(void)_updateSceneGeometryWithSettingObserverContext:(SCD_Struct_UI3)arg1 ;
...
-(char)_shakeToUndoEnabled;
-(id)_motionKeyWindow;
-(char)_shouldShowAlertForUndoManager:(id)arg1 ;
...
-(char)_prepareButtonEvent:(id)arg1 withPressInfo:(id)arg2 ;
-(char)_prepareButtonEvent:(id)arg1 type:(int)arg2 phase:(int)arg3 timestamp:(double)arg4 force:(float)arg5 clickCount:(unsigned)arg6 longClick:(char)arg7 ;
...
-(void)_updateStateRestorationArchiveForBackgroundEvent:(/*^block*/id)arg1 saveState:(char)arg2 exitIfCouldNotRestoreState:(char)arg3 updateSnapshot:(char)arg4 ;
...
-(char)_shouldUpdateSerializableKeyCommandsForResponder:(id)arg1 ;
...
-(unsigned)_userNotificationTypes;
-(id)_userNotificationCategories;
-(void)_getUserNotificationTypesWithCompletionHandler:(/*^block*/id)arg1 ;
-(void)_getUserNotificationCategorieWithCompletionHandler:(/*^block*/id)arg1 ;
-(unsigned)_enabledRemoteNotificationTypes;
-(void)_getEnabledRemoteNotificationTypesWithCompletionHandler:(/*^block*/id)arg1 ;
-(void)_registerForRemoteNotificationTypes:(unsigned)arg1 ;
-(void)registerForRemoteNotifications;
-(void)_scheduleLocalNotification:(id)arg1 ;
-(void)_getScheduledLocalNotificationsWithCompletionHandler:(/*^block*/id)arg1 ;
-(void)setNetworkActivityIndicatorVisible:(char)arg1 ;
-(void)_hideNetworkActivityIndicator;
-(double)backgroundTimeRemaining;
-(char)_UIApplicationLegacyVoipAllowed;
-(id)_backgroundModes;
...
-(char)activityContinuationManagerHandleErrorsByConfiguringProgressUI:(id)arg1 ;
-(char)activityContinuationManager:(id)arg1 willContinueUserActivityWithType:(id)arg2 ;
-(char)activityContinuationManager:(id)arg1 continueUserActivity:(id)arg2 ;
...
-(char)_isActivatedIgnoringReason:(int)arg1 ;
...
-(unsigned)_restorationArchiveProtectionClass;
...
-(void)emitPPTStartTracePointForTestName:(id)arg1 identifier:(unsigned)arg2 ;
-(void)startedSubTest:(id)arg1 forTest:(id)arg2 withMetrics:(id)arg3 ;
-(id)subTest:(id)arg1 ForTest:(id)arg2 withMetrics:(id)arg3 ;
-(void)emitPPTStartTracePointForSubTestName:(id)arg1 identifier:(unsigned)arg2 testIdentifier:(unsigned)arg3 ;
-(void)emitPPTEndTracePointForSubTestName:(id)arg1 identifier:(unsigned)arg2 ;
...
-(void)emitPPTEndTracePointForTestName:(id)arg1 identifier:(unsigned)arg2 ;
-(char)isRunningTest;
...
-(void)_leak;
-(void)rotateIfNeeded:(int)arg1 before:(/*^block*/id)arg2 after:(/*^block*/id)arg3 ;
-(char)launchedToTest;
...
-(void)finishedSubTest:(id)arg1 forTest:(id)arg2 waitForCommit:(char)arg3 ;
-(char)isPPTAvailable;
