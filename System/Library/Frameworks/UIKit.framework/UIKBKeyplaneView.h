...
-(char)validForKeyplane:(id)arg1 withVisualStyle:(int)arg2 ;
...
-(char)useDefaultKeyplaneCacheTokenForRenderFlags:(int)arg1 ;
-(UIKBTree *)defaultKeyplane;
-(int)cornerMaskForKey:(id)arg1 recursive:(char)arg2 ;
-(void)cancelDelayedDeactivation;
-(void)performDelayedDeactivation:(id)arg1 ;
-(void)scheduleDelayedDeactivation;
-(char)_shouldAllowKey:(id)arg1 ;
...
-(char)shouldAnimateInKeyView:(id)arg1 ;
-(char)shouldAnimateOutKeyView:(id)arg1 ;
