...
@property (assign,setter=_setIndependentBarStyle:,nonatomic) int _independentBarStyle; 
@property (assign,setter=_setBackgroundHidden:,nonatomic) char _backgroundHidden;                                                             //@synthesize _backgroundHidden=__backgroundHidden - In the implementation block
...
-(float)_desiredHeightForBarMetrics:(int)arg1 defaultHeightBlock:(/*^block*/id)arg2 ;
-(char)_needsSizeTransitionToItem:(id)arg1 barMetrics:(int)arg2 defaultHeightBlock:(/*^block*/id)arg3 ;
...
-(void)_setBackgroundHidden:(char)arg1 ;
