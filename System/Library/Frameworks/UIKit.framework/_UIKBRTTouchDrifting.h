...
@interface _UIKBRTTouchDrifting : _UIKBRTKeyboardTouchObserver {
	...
	char _supportsDrifting;
	char _leftDriftRemovingItems;
	char _rightDriftRemovingItems;
...
@property (assign,nonatomic) char supportsDrifting;                                        //@synthesize supportsDrifting=_supportsDrifting - In the implementation block
...
@property (assign,nonatomic) char leftDriftRemovingItems;                                  //@synthesize leftDriftRemovingItems=_leftDriftRemovingItems - In the implementation block
...
@property (assign,nonatomic) char rightDriftRemovingItems;                                 //@synthesize rightDriftRemovingItems=_rightDriftRemovingItems - In the implementation block
...
-(void)_updateDriftForFingers:(id)arg1 leftHand:(char)arg2 newestTouch:(id)arg3 ;
...
-(void)addTouchLocation:(CGPoint)arg1 withRadius:(float)arg2 withTouchTime:(double)arg3 withIdentifier:(id)arg4 ;
-(void)updateTouchWithIdentifier:(id)arg1 withTouchTime:(double)arg2 resultingError:(CGPoint)arg3 rowOffsetFromHomeRow:(int)arg4 ;
-(void)ignoreTouchWithIdentifier:(id)arg1 withTouchTime:(double)arg2 ;
-(void)moveTouchWithIdentifier:(id)arg1 toLocation:(CGPoint)arg2 withRadius:(float)arg3 atTouchTime:(double)arg4 ;
-(void)removeTouchWithIdentifier:(id)arg1 touchCancelled:(char)arg2 ;
...
-(char)supportsDrifting;
-(void)setSupportsDrifting:(char)arg1 ;
...
-(char)leftDriftRemovingItems;
-(void)setLeftDriftRemovingItems:(char)arg1 ;
...
-(char)rightDriftRemovingItems;
-(void)setRightDriftRemovingItems:(char)arg1 ;
