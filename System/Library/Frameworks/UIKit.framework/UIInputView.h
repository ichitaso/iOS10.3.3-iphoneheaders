...
@property (assign,nonatomic) char allowsSelfSizing;                              //@synthesize allowsSelfSizing=_allowsSelfSizing - In the implementation block
...
-(void)setAllowsSelfSizing:(char)arg1 ;
-(char)_suppressBackgroundStyling;
