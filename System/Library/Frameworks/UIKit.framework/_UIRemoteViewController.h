...
@interface _UIRemoteViewController : UIViewController <_UIRemoteViewController_ViewControllerOperatorInterface, UIActionSheetDelegate> {
	...
	char _sizeTrackingViewShouldTranslateAutoResizeMaskIntoConstraints;
	int _sizeTrackingViewAutoResizeMask;
	CGSize _serviceScreenSize;
	char _alreadySentFence;
	...
	char _isUnderlappingStatusBar;
	char __shouldUpdateRemoteTextEffectsWindow;
...
@property (assign,setter=_setShouldUpdateRemoteTextEffectsWindow:,nonatomic) char _shouldUpdateRemoteTextEffectsWindow; 
...
-(char)_shouldUpdateRemoteTextEffectsWindow;
-(char)_isUpdatingSize;
-(char)_needsUnderflowPropertyUpdate;
...
-(void)_cancelProxiedEditAlertViewAnimated:(char)arg1 ;
...
-(void)__setInterdictServiceViewTouches:(char)arg1 ;
...
-(void)_setShouldUpdateRemoteTextEffectsWindow:(char)arg1 ;
...
-(char)__interdictServiceViewTouches;
