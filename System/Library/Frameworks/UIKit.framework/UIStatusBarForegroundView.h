...
@class UIStatusBarLayoutManager, NSMutableArray, UIStatusBarComposedData, UIStatusBarForegroundStyleAttributes, UIStatusBar;

@interface UIStatusBarForegroundView : UIView {

	char _usesVerticalLayout;
	char _itemIsEnabled[41];
...
-(void)_reflowItemViewsCrossfadingCenterWithDuration:(double)arg1 timeWasEnabled:(char)arg2 ;
...
-(char)willChangeNavigationItemDisplayWithSystemNavigationAction:(id)arg1 ;
-(void)reflowItemViewsCrossfadingCenter:(id)arg1 duration:(double)arg2 ;
-(char)isShowingBreadcrumb;
-(void)animateUnlock;
-(void)jiggleLockIcon;
-(char)rectIntersectsTimeItem:(CGRect)arg1 ;
