...
-(char)_alwaysConstrainsScale;
-(char)allowsLinkPreview;
-(char)_webView:(id)arg1 previewIsAllowedForPosition:(CGPoint)arg2 ;
-(id)_webView:(id)arg1 previewViewControllerForURL:(id)arg2 ;
-(void)_webView:(id)arg1 willPresentPreview:(id)arg2 ;
-(void)_webView:(id)arg1 didDismissPreview:(id)arg2 committing:(char)arg3 ;
...
-(void)_setIsBlankBeforeFirstNonEmptyLayout:(char)arg1 ;
...
-(void)_setAlwaysConstrainsScale:(char)arg1 ;
...
-(void)_setAllowsPictureInPictureVideo:(char)arg1 ;
-(char)_allowsPictureInPictureVideo;
