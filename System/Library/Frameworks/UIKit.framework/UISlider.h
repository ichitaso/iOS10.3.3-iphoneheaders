...
@class UIImageView, UIView, UIColor, NSArray, _UIFeedbackEdgeBehavior, _UIFeedbackModulationBehavior, UIImage;
...
@property (setter=_setEdgeFeedbackBehavior:,getter=_edgeFeedbackBehavior,nonatomic,retain) _UIFeedbackEdgeBehavior * edgeFeedbackBehavior; 
@property (setter=_setModulationFeedbackBehavior:,getter=_modulationFeedbackBehavior,nonatomic,retain) _UIFeedbackModulationBehavior * modulationFeedbackBehavior; 
