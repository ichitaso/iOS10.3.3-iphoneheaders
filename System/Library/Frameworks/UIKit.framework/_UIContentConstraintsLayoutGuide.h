...
@interface _UIContentConstraintsLayoutGuide : UILayoutGuide {
	...
	char _wantsMaximumSizeConstraintsActive;
	char _wantsMinimumSizeConstraintsActive;
...
@property (nonatomic,readonly) char wantsMaximumSizeConstraintsActive;                    //@synthesize wantsMaximumSizeConstraintsActive=_wantsMaximumSizeConstraintsActive - In the implementation block
...
@property (nonatomic,readonly) char wantsMinimumSizeConstraintsActive;                    //@synthesize wantsMinimumSizeConstraintsActive=_wantsMinimumSizeConstraintsActive - In the implementation block
...
-(void)_setAllMarginConstraintsActive:(char)arg1 ;
-(void)_updateAllSizeConstraints;
-(void)_setAllSizeConstraintsActive:(char)arg1 ;
-(CGSize)maximumSize;
