...
-(void)_setContentView:(id)arg1 addToHierarchy:(char)arg2 ;
...
-(void)_updateFocusedFloatingContentControlStateAnimated:(char)arg1 ;
-(void)_updateFocusedFloatingContentControlStateInContext:(id)arg1 withAnimationCoordinator:(id)arg2 animated:(char)arg3 ;
