...
@interface _UIStackedImageContainerView : UIView {
	...
	char _installsMotionEffectsWhenFocused;
	UIImage* _stackImage;
...
@property (assign,getter=isStackFocused,nonatomic) char stackFocused; 
@property (assign,nonatomic) char installsMotionEffectsWhenFocused;                           //@synthesize installsMotionEffectsWhenFocused=_installsMotionEffectsWhenFocused - In the implementation block
...
-(void)setStackFocused:(char)arg1 withFocusAnimationCoordinator:(id)arg2 ;
-(char)isPressed;
...
-(void)_setStackFocused:(char)arg1 animated:(char)arg2 focusAnimationCoordinator:(id)arg3 ;
-(void)_installMotionEffects;
-(void)_uninstallMotionEffects;
-(char)installsMotionEffectsWhenFocused;
-(char)isStackFocused;
-(void)setStackImage:(UIImage *)arg1 ;
-(void)setConstructedStackImage:(NSObject*<UINamedLayerStack>)arg1 ;
-(void)setStackFocused:(char)arg1 ;
-(void)setInstallsMotionEffectsWhenFocused:(char)arg1 ;
-(UIImage *)stackImage;
