...
@interface UIMorphingLabel : UIView {
	...
	UIView* _colorView;
	NSRange _memo[5151];
	SCD_Struct_UI98 _alignment[100];
...
@property (assign,nonatomic) char enableAnimation;                     //@synthesize enableAnimation=_enableAnimation - In the implementation block
...
-(void)setEnableAnimation:(char)arg1 ;
-(id)glyphViewWithImage:(id)arg1 isColorGlyph:(char)arg2 ;
-(float)flushAmount;
-(void)hideGlyph:(id)arg1 ;
-(void)baseInit;
-(float)alphaForFrame:(CGRect)arg1 ;
-(unsigned)calculateHardAlignment:(SCD_Struct_UI99*)arg1 size:(unsigned)arg2 fromGlyphs:(const unsigned short*)arg3 count:(unsigned)arg4 toGlyphs:(const unsigned short*)arg5 count:(unsigned)arg6 ;
