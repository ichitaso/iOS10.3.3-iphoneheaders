...
-(char)_customEventType:(unsigned*)arg1 andSystemSoundID:(unsigned*)arg2 fromIdentifier:(id)arg3 ;
...
-(id)identifierForCustomDiscreteFeedbackWithEventType:(unsigned)arg1 systemSoundID:(unsigned long)arg2 ;
