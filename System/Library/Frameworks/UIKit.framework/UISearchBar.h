...
@class UISearchBarTextField, UILabel, UIButton, UIColor, UIImageView, NSString, NSArray, UIView, _UISearchBarNavigationItem, _UISearchBarScopeBarBackground, UIBarButtonItem, _UIBackdropView, UITapGestureRecognizer, UITextInputTraits, UISearchController, UITextInputAssistantItem, UIImage, NSIndexSet, UIInputContextHistory;
