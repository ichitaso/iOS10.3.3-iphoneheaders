...
-(float)_constantForMultilineTextWidthDisambiguationConstraintWithNumberOfVisibleItems:(unsigned)arg1 ;
-(int)_minAttributeForGapConstraintRespectingBaselineRelative:(char)arg1 ;
-(int)_minAttributeForGapConstraint;
-(int)_maxAttributeForGapConstraintRespectingBaselineRelative:(char)arg1 ;
