...
@property (assign,setter=_setShowOnlyAddPeople:,getter=_showOnlyAddPeople,nonatomic) char showOnlyAddPeople;                                                                                //@synthesize showOnlyAddPeople=_showOnlyAddPeople - In the implementation block
...
-(void)_setShowOnlyAddPeople:(char)arg1 ;
@end
