...
@interface UIWebClip : NSObject {
	...
	unsigned _webClipStatusBarStyle;
...
@property (assign,nonatomic) unsigned webClipStatusBarStyle;                   //@synthesize webClipStatusBarStyle=_webClipStatusBarStyle - In the implementation block
...
-(char)iconIsPrerendered;
-(unsigned)supportedOrientations;
-(unsigned)webClipStatusBarStyle;
-(void)setWebClipStatusBarStyle:(unsigned)arg1 ;
@end
