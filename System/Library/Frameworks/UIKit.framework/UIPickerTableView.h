...
@property (assign,setter=_setSelectionBarRow:,nonatomic) int selectionBarRow;                           //@synthesize selectionBarRow=_selectionBarRow - In the implementation block
...
@property (setter=_setPlaysFeedback:,getter=_playsFeedback) char playsFeedback;                         //@synthesize playsFeedback=_playsFeedback - In the implementation block
...
-(char)_playsFeedback;
-(void)_setPlaysFeedback:(char)arg1 ;
@end
