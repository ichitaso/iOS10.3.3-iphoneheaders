...
@property (assign,nonatomic) char actionIsImport;                                //@synthesize actionIsImport=_actionIsImport - In the implementation block
...
+(id)openInActivitiesForItems:(id)arg1 sourceIsManaged:(char)arg2 ;
+(id)activitiesForFileURL:(id)arg1 sourceIsManaged:(char)arg2 ;
...
-(void)setActionIsImport:(char)arg1 ;
-(id)initWithApplicationProxy:(id)arg1 documentProxy:(id)arg2 sourceIsManaged:(char)arg3 actionIsImport:(char)arg4 ;
