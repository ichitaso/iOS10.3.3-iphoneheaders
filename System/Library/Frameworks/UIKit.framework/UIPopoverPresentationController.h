...
@property (assign,setter=_setArrowOffset:,getter=_arrowOffset,nonatomic) float _arrowOffset; 
...
@property (assign,setter=_setShouldDisableInteractionDuringTransitions:,getter=_shouldDisableInteractionDuringTransitions,nonatomic) char shouldDisableInteractionDuringTransitions;              //@synthesize shouldDisableInteractionDuringTransitions=_shouldDisableInteractionDuringTransitions - In the implementation block
...
-(void)_setArrowOffset:(float)arg1 ;
...
-(void)_setShouldDisableInteractionDuringTransitions:(char)arg1 ;
@end
