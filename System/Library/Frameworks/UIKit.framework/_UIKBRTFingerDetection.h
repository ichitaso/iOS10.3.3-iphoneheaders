...
-(id)fingerIdsRelatedToTouchWithIdentifier:(id)arg1 sinceTimestamp:(double)arg2 includeThumbs:(char)arg3 ;
-(unsigned)fingerIdForTouchWithIdentifier:(id)arg1 ;
-(id)touchIdentifiersForFingerId:(unsigned)arg1 ;
-(CGPoint)touchLocationForFingerId:(unsigned)arg1 ;
-(void)_updateTouchInfoForFingerID:(unsigned)arg1 ;
-(void)_updateFingerFeedback;
-(char)_linkTouchesInArray:(id)arg1 withIndexes:(id)arg2 opposingHandIndexes:(id)arg3 unassignedIndexes:(id)arg4 thumb:(id)arg5 ;
