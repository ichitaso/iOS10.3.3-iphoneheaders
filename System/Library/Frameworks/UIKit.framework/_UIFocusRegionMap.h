...
-(id)linearlyOrderedCandidatesForFocusMovement:(id)arg1 fromView:(id)arg2 indexForFocusedView:(unsigned*)arg3 ;
-(id)nearestCandidateFromRect:(CGRect)arg1 ;
-(id)debugQuickLookObject;
-(char)_containsFocusableRegionForView:(id)arg1 ;
...
-(id)_closestFocusableRegionInArray:(id)arg1 toPoint:(CGPoint)arg2 usingHeading:(unsigned)arg3 withFocusedView:(id)arg4 consideringFavoredRegion:(char)arg5 includingFocusedView:(char)arg6 ;
-(id)_nearestCandidateForFocusMovement:(id)arg1 fromFocusedView:(id)arg2 withFocusedRect:(CGRect)arg3 includingFocusedView:(char)arg4 ;
-(CGRect)minimumSearchArea;
-(CGPoint)_focusCandidateSearchOriginForFocusedFrame:(CGRect)arg1 heading:(unsigned)arg2 minimumSearchArea:(CGRect)arg3 ;
-(CGRect)_focusCandidateSearchRectForFocusedFrame:(CGRect)arg1 heading:(unsigned)arg2 minimumSearchArea:(CGRect)arg3 ;
-(CGRect)_viewSearchRectForFocusedFrame:(CGRect)arg1 focusCandidateSearchRect:(CGRect)arg2 includesFocusedFrame:(char)arg3 ;
...
-(id)_closestFocusableRegionInArray:(id)arg1 toPoint:(CGPoint)arg2 usingHeading:(unsigned)arg3 ;
@end
