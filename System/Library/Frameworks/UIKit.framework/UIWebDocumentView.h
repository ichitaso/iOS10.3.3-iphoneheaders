...
@interface UIWebDocumentView : UIWebTiledView <DDDetectionControllerInteractionDelegate, UIPreviewItemDelegate, _UIRotatingAlertControllerDelegate, UITextAutoscrolling, UIAutoscrollContainer, UIGestureRecognizerDelegate, UIKeyboardInput, UITextInputPrivate, UIKeyInput, UIModalViewDelegate, UITextInputTokenizer, _UIWebDoubleTapDelegate, UIWebFileUploadPanelDelegate, WebEditingDelegate, WebFrameLoadDelegate> {
	...
	char _panGestureWasEnabled;
	char _pinchGestureWasEnabled;
	UIPreviewItemController* _previewItemController;
	SCD_Struct_UI41 _interaction;
...
@property (assign,nonatomic) char alwaysConstrainsScale; 
...
-(void)setAllowsShrinkToFit:(char)arg1 forDocumentTypes:(int)arg2 ;
...
-(void)_removeShareController:(char)arg1 ;
...
-(void)setAlwaysConstrainsScale:(char)arg1 ;
-(char)alwaysConstrainsScale;
...
-(char)_previewAllowedForPosition:(CGPoint)arg1 ;
...
-(CGRect)computeRectForElement:(id)arg1 withHighligh:(id)arg2 isInverted:(char)arg3 ;
...
-(id)beginPrintModeWithWidth:(float)arg1 height:(float)arg2 startOffset:(float)arg3 shrinkToFit:(char)arg4 tileClippedContent:(char)arg5 forFrame:(id)arg6 ;
...
-(char)isInPrintMode;
-(id)beginPrintModeWithWidth:(float)arg1 height:(float)arg2 startOffset:(float)arg3 shrinkToFit:(char)arg4 forFrame:(id)arg5 ;
