...
@class NSHashTable, NSMutableArray, UIView, NSMutableSet, NSXPCConnection, _UIKeyboardChangedInformation, NSString, NSArray, UIWindow;
...
-(void)prepareToMoveKeyboard:(CGRect)arg1 withIAV:(CGRect)arg2 showing:(char)arg3 forScreen:(id)arg4 ;
