...
@property (nonatomic,readonly) SCD_Struct_UI20 __sizeClassPair; 
...
@property (assign,setter=__setHostViewUnderlapsStatusBar:,nonatomic) char __hostViewUnderlapsStatusBar;                                                                                             //@synthesize __hostViewUnderlapsStatusBar=___hostViewUnderlapsStatusBar - In the implementation block
...
@property (assign,setter=_setRepresentsSelfHostedContent:,getter=_representsSelfHostedContent,nonatomic) char _representsSelfHostedContent;                                                         //@synthesize _representsSelfHostedContent=__representsSelfHostedContent - In the implementation block
...
+(void)_enumerateWindowsIncludingInternalWindows:(char)arg1 onlyVisibleWindows:(char)arg2 allowMutation:(char)arg3 withBlock:(/*^block*/id)arg4 ;
...
+(void*)createIOSurfaceOnScreen:(id)arg1 withContextIds:(const unsigned*)arg2 count:(unsigned)arg3 frame:(CGRect)arg4 baseTransform:(CGAffineTransform)arg5 ;
...
-(void)_updateLayerOrderingAndSetLayerHidden:(char)arg1 ;
...
-(char)_windowOwnsInterfaceOrientation;
...
-(void)_setAttachedToScene:(char)arg1 ;
-(void)_createContext;
-(char)keepContextInBackground;
-(void)_destroyContext;
-(char)_isKeyWindowForDeferral;
...
-(char)_resizeWindowFrameToSceneBoundsIfNecessary;
-(void)makeKeyWindow;
...
-(char)_areOverlayInsetsValid:(UIEdgeInsets)arg1 ;
...
-(char)_touchesInsideShouldHideCalloutBarForViewHierarchy:(id)arg1 ;
-(id)_firstResponder;
...
-(char)_guardSizeTransitionFromAnimations;
...
-(void)_updateInterfaceOrientationFromActiveInterfaceOrientationIfRotationEnabled:(char)arg1 ;
...
-(void)_updateToNotificationProvidedInterfaceOrientation:(int)arg1 animated:(char)arg2 ;
...
-(void)_updateWindowBackgroundColorForUserInterfaceStyle:(int)arg1 force:(char)arg2 ;
-(void)_removeFocusEngine;
-(unsigned)_edgesForSystemGesturesTouchDelay;
-(unsigned)_edgeForTouch:(id)arg1 ;
...
-(char)_canAffectDisplayAdaptation;
...
-(void)_setIsResigningFirstResponderFromHost:(char)arg1 ;
...
-(char)_representsSelfHostedContent;
-(void)_setRepresentsSelfHostedContent:(char)arg1 ;
-(void)_updateInterfaceOrientationFromActiveInterfaceOrientation:(char)arg1 ;
