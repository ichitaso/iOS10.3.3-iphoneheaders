...
#import <UIKit/_UINavigationBarDelegatePrivate.h>
...
@class UILayoutContainerView, UINavigationBar, UIToolbar, UIView, UIViewController, UITapGestureRecognizer, _UINavigationControllerPalette, NSMapTable, NSString, _UINavigationParallaxTransition, _UINavigationInteractiveTransition, NSUUID, UIFocusContainerGuide, _UIBarPanGestureRecognizer, _UIAnimationCoordinator, _UIBarTapGestureRecognizer, UINavigationTransitionView, NSArray, UIGestureRecognizer, UIPanGestureRecognizer;
...
@interface UINavigationController : UIViewController <UIGestureRecognizerDelegatePrivate, _UINavigationBarDelegatePrivate, UILayoutContainerViewDelegate> {
	...
	char __shouldUseBuiltinAnimator;
	char __usingBuiltinAnimator;
	char __toolbarAnimationWasCancelled;
	char __navigationBarAnimationWasCancelled;
	Class _toolbarClass;
...
@property (assign,setter=_setAllowChildSplitViewControllers:,getter=_allowChildSplitViewControllers,nonatomic) char allowChildSplitViewControllers; 
...
@property (assign,setter=_setPreferredNavigationBarPosition:,nonatomic) int _preferredNavigationBarPosition;                                                           //@synthesize _preferredNavigationBarPosition=__preferredNavigationBarPosition - In the implementation block
...
@property (assign,setter=_setShouldUseBuiltinAnimator:,nonatomic) char _shouldUseBuiltinAnimator;                                                                      //@synthesize _shouldUseBuiltinAnimator=__shouldUseBuiltinAnimator - In the implementation block
...
@property (assign,setter=_setToolbarAnimationWasCancelled:,nonatomic) char _toolbarAnimationWasCancelled;                                                              //@synthesize _toolbarAnimationWasCancelled=__toolbarAnimationWasCancelled - In the implementation block
@property (assign,setter=_setNavigationBarAnimationWasCancelled:,nonatomic) char _navigationBarAnimationWasCancelled;                                                  //@synthesize _navigationBarAnimationWasCancelled=__navigationBarAnimationWasCancelled - In the implementation block
...
-(char)_shouldUseBuiltinAnimator;
-(void)_setShouldUseBuiltinAnimator:(char)arg1 ;
...
-(char)_hasInterruptibleNavigationTransition;
...
-(void)_setIsWrappingDuringAdaptation:(char)arg1 ;
...
-(id)_navigationItemsCallingPublicAccessor:(char)arg1 ;
...
-(char)_allowChildSplitViewControllers;
...
-(void)_setNavigationBarAnimationWasCancelled:(char)arg1 ;
-(void)_setToolbarAnimationWasCancelled:(char)arg1 ;
...
-(char)_isViewControllerFullScene;
...
-(char)_navigationBarAnimationWasCancelled;
...
-(void)_repositionPaletteWithNavigationBarHidden:(char)arg1 duration:(double)arg2 shouldUpdateNavigationItems:(char)arg3 ;
...
-(char)_toolbarAnimationWasCancelled;
...
-(void)_setAllowChildSplitViewControllers:(char)arg1 ;
...
-(void)_setNavigationSoundsEnabled:(char)arg1 ;
-(char)_navigationSoundsEnabled;
-(Class)_toolbarClass;
