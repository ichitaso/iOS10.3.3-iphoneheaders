...
-(char)_viewControllerIsChildOfExpandedSplitViewController:(id)arg1 ;
-(void)_activateFeedback;
-(id)_transitionDelegateForPreviewViewController:(id)arg1 atPosition:(CGPoint)arg2 inView:(id)arg3 ;
-(char)_usesPreviewInteraction;
-(void)_configureCommitInteractionProgressForView:(id)arg1 ;
-(char)configureRevealTransformSourceViewSnapshotSuppressionFromLocation:(CGPoint)arg1 inView:(id)arg2 ;
-(char)_usesPreviewPresentationController;
...
-(void)_setCalloutBarHidden:(char)arg1 ;
-(char)statusBarWasHidden;
-(void)_setStatusBarHidden:(char)arg1 ;
-(char)startInteractivePreviewAtLocation:(CGPoint)arg1 inView:(id)arg2 ;
...
-(char)startInteractivePreviewWithGestureRecognizer:(id)arg1 ;
