...
@property (assign,nonatomic) char suppressesAppearance; 
...
-(void)fadeAnimationDidStopWithContext:(id)arg1 finished:(char)arg2 ;
-(void)resetPage;
...
-(void)setSuppressesAppearance:(char)arg1 ;
@end
