...
@interface UIView : UIResponder <_UIScrollNotification, UITextEffectsOrdering, NSISVariableDelegate, _UILayoutItem, _UIMultilineTextContentSizing, NSISEngineDelegate, _UITraitEnvironmentInternal, _UIFocusEnvironmentInternal, _UIFocusRegionContainerInternal, _UILegacyFocusRegion, _UIGeometryChangeObserver, _UIFocusEnvironmentPrivate, _UIFocusRegionContainer, UIFocusContainer, NSCoding, UIAppearance, UIAppearanceContainer, UIDynamicItem, UITraitEnvironment, UICoordinateSpace, UIFocusItem, CALayerDelegate> {
	...
	unsigned _unsatisfiableConstraintsLoggingSuspensionCount;
...
@property (assign,setter=_setHasMirrorTransform:,nonatomic) char _hasMirrorTransform; 
@property (assign,setter=_setDisableLayoutFlushingCount:,nonatomic) int _disableLayoutFlushingCount; 
@property (nonatomic,readonly) char _isUnsatisfiableConstraintsLoggingSuspended; 
...
@property (assign,setter=_setPreferedContentsFormat:,nonatomic) int _preferedContentsFormat;                                                                                                                                            //@synthesize _preferedContentsFormat=__preferedContentsFormat - In the implementation block
@property (assign,setter=_setNeedsContentsFormatUpdate:,nonatomic) char _needsContentsFormatUpdate; 
...
@property (assign,setter=_setMultilineContextWidth:,nonatomic) float _multilineContextWidth; 
...
@property (nonatomic,readonly) char _isInLayoutSubviews; 
...
@property (assign,setter=_setIgnoresTemplateLayoutView:,nonatomic) char _ignoresTemplateLayoutView; 
...
@property (assign,setter=_setCornerRadius:,nonatomic) float _cornerRadius; 
@property (assign,nonatomic) char wantsDeepColorDrawing;                                                                                                                                                                                //@synthesize wantsDeepColorDrawing=_wantsDeepColorDrawing - In the implementation block
...
@property (nonatomic,readonly) char canBecomeFocused; 
...
+(void)_finalizeStoppedAnimationWithUUID:(id)arg1 reverseAnimation:(char)arg2 state:(id)arg3 performCompletionsImmediately:(char)arg4 ;
...
+(void)modifyTrackedAnimations:(id)arg1 removeOnCompletion:(char)arg2 copyAnimation:(char)arg3 block:(/*^block*/id)arg4 ;
+(void)modifyTrackedAnimations:(id)arg1 removeOnCompletion:(char)arg2 animationFactory:(/*^block*/id)arg3 block:(/*^block*/id)arg4 ;
+(void)mapTrackedAnimations:(id)arg1 withBlock:(/*^block*/id)arg2 ;
+(void)_testIfFirstView:(id)arg1 secondView:(id)arg2 areDescendantsOfView:(id)arg3 results:(char)arg4 ;
+(void)performWithPropertyAccessMode:(int)arg1 block:(/*^block*/id)arg2 ;
...
+(char)_isAccessingModel;
+(char)_isInAnimationBlockWithAnimationsEnabled;
+(void)throttledFlush;
...
+(id)_enableAnimationTracking:(char)arg1 ;
+(id)_enableAnimationTracking;
+(void)_disableAnimationTracking:(id)arg1 ;
+(void)_updateModelValuesForAnimationWithUUID:(id)arg1 useInitialValues:(char)arg2 animatable:(char)arg3 stateBlock:(/*^block*/id)arg4 animationBlock:(/*^block*/id)arg5 ;
...
-(char)_cachedTraitCollectionIsValid;
...
-(char)_strictDescendantNeedsDoubleUpdateConstraints;
...
-(char)_ignoresTemplateLayoutView;
-(void)_setIgnoresTemplateLayoutView:(char)arg1 ;
...
-(char)_needsContentsFormatUpdate;
...
-(void)_applyISEngineLayoutValuesToBoundsOnly:(char)arg1 ;
...
-(void)sendAppearanceCallbacksForAppearingViewWithSubHierarchyAppearanceState:(int)arg1 animated:(char)arg2 appearingType:(int)arg3 ;
-(void)applyUpdatesRecursively:(char)arg1 subHierarchyAppearanceState:(int)arg2 immediateAnimated:(char)arg3 newChange:(char)arg4 ;
-(void)sendViewWillAppearAnimated:(char)arg1 ;
-(void)sendViewDidAppearAnimated:(char)arg1 ;
-(void)sendViewWillDisappearAnimated:(char)arg1 ;
-(void)sendViewDidDisappearAnimated:(char)arg1 ;
-(void)sendAppearanceCallbacksForDisappearingViewWithSubHierarchyAppearanceState:(int)arg1 animated:(char)arg2 ;
...
-(void)_informSuperviewChainThatStrictDescendantNeedsDoubleUpdateConstraintsIsInvalidIncludingSelf:(char)arg1 ;
...
-(id)_layoutHashesStackCreateIfNeeded:(char)arg1 ;
-(unsigned)_layoutHash;
...
-(char)_UIViewDebuggingIsViewClipping;
-(void)_strokeClippedViewIfNecessary;
-(char)_clippingDetected;
...
-(void)_needsDoubleUpdateConstraintsPassMayHaveChangedFrom:(char)arg1 ;
...
-(char)_shouldSuspendLayoutEngine;
...
-(char)_la_isVisible;
-(void)_setHasMirrorTransform:(char)arg1 ;
-(char)_hasMirrorTransform;
...
-(char)_preWhitetailUsesAutoresizingConstraints;
...
-(char)_hostsLayoutEngineAllowsTAMIC_NO;
...
-(void)_recursiveCollectTemporaryInternalConstraintsWithEngine:(id)arg1 ignoreAutoresizingMaskConstraints:(char)arg2 returningConstraintsForViewsNeedingSecondPass:(id*)arg3 currentTargetWidth:(float)arg4 ;
-(void)_makeTemporaryInternalConstraintsWithEngine:(id)arg1 ignoreAutoresizingMaskConstraints:(char)arg2 returningConstraintsForViewsNeedingSecondPass:(id*)arg3 currentTargetWidth:(float)arg4 ;
-(char)_usesHostedLayoutEngineForFittingSizeCalculation;
...
-(char)_intrinsicContentSizeConstraintsAreClean;
...
-(void)_stopObservingVariablesOnlyToSupportTAMICChange:(char)arg1 ;
-(void)_createJostledViewsIfNecessary;
-(void)_clearLayoutVariableObservationsOnlyToSupportTAMICChange:(char)arg1 ;
-(void)_startObservingVariablesOnlyToSupportTAMICChange:(char)arg1 ;
...
-(id)_constraintsBrokenWhileUnsatisfiableConstraintsLoggingSuspendedCreateIfNecessary:(char)arg1 ;
-(void)_recursiveUpdateConstraintsIfNeededCollectingViews:(id)arg1 forSecondPass:(char)arg2 ;
-(void)_sendUpdateConstraintsIfNecessaryForSecondPass:(char)arg1 ;
-(void)_updateConstraintsIfNeededCollectingViews:(id)arg1 forSecondPass:(char)arg2 ;
