...
@property (assign,nonatomic) float maxTileHeight; 
@property (assign,setter=_setFreezeTextContainerSize:,getter=_freezeTextContainerSize,nonatomic) char freezeTextContainerSize; 
