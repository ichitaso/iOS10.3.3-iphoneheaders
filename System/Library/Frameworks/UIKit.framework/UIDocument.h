...
-(void)_updatePermissionsState:(char)arg1 ;
-(void)_sendStateChangedNotification;
-(char)_isOpen;
-(void)_setEditingTemporarilyDisabled:(char)arg1 ;
...
-(void)_setEditingDisabledDueToPermissions:(char)arg1 ;
-(char)_shouldAllowWritingInResponseToPresenterMessage;
-(char)_isEditingTemporarilyDisabled;
...
-(char)_isEditingDisabledDueToPermissions;
