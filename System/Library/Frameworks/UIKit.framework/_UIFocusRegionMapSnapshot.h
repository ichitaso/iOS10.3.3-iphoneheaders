...
@property (assign,getter=isPrivateSnapshot,nonatomic) char privateSnaphot;                        //@synthesize privateSnaphot=_privateSnaphot - In the implementation block
...
-(CGRect)_clippedRegionFrame:(CGRect)arg1 isFocusGuide:(char)arg2 ;
...
-(void)_addFocusableRegion:(id)arg1 isFocusGuide:(char)arg2 withFrame:(CGRect)arg3 ;
...
-(char)isPrivateSnapshot;
-(void)setPrivateSnaphot:(char)arg1 ;
