...
@property (assign,setter=_setDefaultAxis:,getter=_defaultAxis,nonatomic) int defaultAxis;                                //@synthesize defaultAxis=_defaultAxis - In the implementation block
@property (assign,nonatomic) float minDistanceFromEdge;                                                                  //@synthesize minDistanceFromEdge=_minDistanceFromEdge - In the implementation block
