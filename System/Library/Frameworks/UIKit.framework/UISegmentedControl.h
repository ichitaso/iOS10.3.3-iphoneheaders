...
+(id)_modernBackgroundSelected:(char)arg1 highlighted:(char)arg2 traitCollection:(id)arg3 ;
...
-(char)_shouldConsumeEventWithPresses:(id)arg1 ;
-(void)_selectFocusedSegment;
-(void)setSelectedSegment:(int)arg1 ;
-(char)_hasEnabledSegment;
...
-(void)_setSegmentedControlAppearance:(SCD_Struct_UI34*)arg1 ;
...
-(id)_uiktest_labelsWithState:(unsigned)arg1 ;
-(id)_uiktest_segmentAtIndex:(unsigned)arg1 ;
