...
@property (assign,nonatomic) unsigned currentDirection;                                   //@synthesize currentDirection=_currentDirection - In the implementation block
...
@property (assign,nonatomic) char useViewForEdges;                                        //@synthesize useViewForEdges=_useViewForEdges - In the implementation block
