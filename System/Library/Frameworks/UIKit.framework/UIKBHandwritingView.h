...
@interface UIKBHandwritingView : UIKBKeyView <UIGestureRecognizerDelegate> {
	...
	SCD_Struct_UI64 _previousPoint;
...
@property (assign,nonatomic) char initialPointPosted;                                            //@synthesize initialPointPosted=_initialPointPosted - In the implementation block
@property (assign,nonatomic) SCD_Struct_UI63 previousPoint;                                      //@synthesize previousPoint=_previousPoint - In the implementation block
...
-(char)shouldCache;
-(char)shouldAllowSelectionGestures:(char)arg1 ;
-(void)clearTouches;
...
-(void)setInitialPointPosted:(char)arg1 ;
-(void)setPreviousPoint:(SCD_Struct_UI63)arg1 ;
-(char)initialPointPosted;
-(SCD_Struct_UI63)previousPoint;
-(void)addInkPoint:(CGPoint)arg1 value:(float)arg2 ;
-(char)endStrokeWithTouches:(id)arg1 event:(id)arg2 ;
@end
