...
@interface UISearchController : UIViewController <UIViewControllerPresenting, _UIScrollNotification, NSCoding, UIViewControllerTransitioningDelegate, UIViewControllerAnimatedTransitioning> {
	...
	char _obscuresBackgroundDuringPresentation;
...
@property (nonatomic,readonly) char _searchbarWasTableHeaderView; 
...
@property (assign,nonatomic) char dimsBackgroundDuringPresentation; 
@property (assign,nonatomic) char obscuresBackgroundDuringPresentation;                                          //@synthesize obscuresBackgroundDuringPresentation=_obscuresBackgroundDuringPresentation - In the implementation block
...
-(char)_searchbarWasTableHeaderView;
...
-(char)obscuresBackgroundDuringPresentation;
-(UISystemInputViewController *)_systemInputViewController;
...
-(void)setObscuresBackgroundDuringPresentation:(char)arg1 ;
