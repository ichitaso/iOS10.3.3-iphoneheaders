...
@property (assign,setter=_setWantsRightToLeftHorizontalMirroringIfNeeded:,nonatomic) char _wantsRightToLeftHorizontalMirroringIfNeeded; 
@property (getter=_fastScrollingIndexBarInsets,nonatomic,readonly) UIEdgeInsets fastScrollingIndexBarInsets; 
...
-(void)_setWantsRightToLeftHorizontalMirroringIfNeeded:(char)arg1 ;
...
-(char)_wantsRightToLeftHorizontalMirroringIfNeeded;
-(UICollectionViewCompositionLayout*)_compositionLayout;
...
-(id)invalidationContextForEndingInteractiveMovementOfItemsToFinalIndexPaths:(id)arg1 previousIndexPaths:(id)arg2 movementCancelled:(char)arg3 ;
