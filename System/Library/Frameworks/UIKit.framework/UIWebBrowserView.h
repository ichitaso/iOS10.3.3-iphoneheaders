...
@interface UIWebBrowserView : UIWebDocumentView <UIWebTouchEventsGestureRecognizerDelegate, UIWebFormAccessoryDelegate, _UIWebRotationDelegate> {
	...
	SCD_Struct_UI79 _messages;
	SCD_Struct_UI80 _pdf;
...
@property (assign,nonatomic) char allowsPictureInPictureVideo; 
...
-(void)setAllowsPictureInPictureVideo:(char)arg1 ;
-(char)allowsPictureInPictureVideo;
