...
@interface UIKeyboardInputModeController : NSObject {
	...
	char _excludeExtensionInputModes;
...
@property (assign,nonatomic) char shouldRunContinuousDiscovery;                                       //@synthesize shouldRunContinuousDiscovery=_shouldRunContinuousDiscovery - In the implementation block
...
-(void)setShouldRunContinuousDiscovery:(char)arg1 ;
...
-(id)nextInputModeInPreferenceListForTraits:(id)arg1 updatePreference:(char)arg2 ;
...
-(id)nextInputModeToUseForTraits:(id)arg1 updatePreference:(char)arg2 ;
