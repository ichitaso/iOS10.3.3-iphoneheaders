...
@class NSSet, UIColor, UIBarButtonItem, UINavigationItem, NSDictionary, UIView, NSString, UIImage;
...
+(id)defaultFont;
+(void)_resetRenderingModesForBackgroundImageView:(id)arg1 inBarStyle:(int)arg2 isEnabled:(char)arg3 withAccessibilityBackground:(char)arg4 wantsBlendModeForAccessibilityBackgrounds:(char)arg5 accessibilityBackgroundTintColor:(id)arg6 ;
-(void)layoutSubviews;
