...
@interface UIKeyboardCandidateGridCell : UICollectionViewCell {
	...
	char _facemarkCategoryAppearance;
	char _emphasizedAppearance;
	char _needsUpdateLabels;
	NSString* _text;
...
@property (assign,nonatomic) char needsUpdateLabels;                         //@synthesize needsUpdateLabels=_needsUpdateLabels - In the implementation block
...
@property (assign,nonatomic) char facemarkCategoryAppearance;                //@synthesize facemarkCategoryAppearance=_facemarkCategoryAppearance - In the implementation block
...
+(id)reuseIdentifier;
+(char)shouldShowImageForGroupTitle:(id)arg1 ;
...
-(void)setFacemarkCategoryAppearance:(char)arg1 ;
...
-(void)updateLabels;
-(void)setNeedsUpdateLabels:(char)arg1 ;
...
-(char)facemarkCategoryAppearance;
-(id)secureContents;
