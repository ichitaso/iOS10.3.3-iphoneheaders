...
@interface UIPopoverController : NSObject <UIDimmingViewDelegate, UIGestureRecognizerDelegatePrivate, UIAppearanceContainer> {
	...
	char _allowsPopoverPresentationToAdapt;
...
@property (assign,setter=_setAllowsPopoverPresentationToAdapt:,getter=_allowsPopoverPresentationToAdapt,nonatomic) char allowsPopoverPresentationToAdapt;              //@synthesize allowsPopoverPresentationToAdapt=_allowsPopoverPresentationToAdapt - In the implementation block
...
-(char)_allowsPopoverPresentationToAdapt;
-(void)_setAllowsPopoverPresentationToAdapt:(char)arg1 ;
@end
