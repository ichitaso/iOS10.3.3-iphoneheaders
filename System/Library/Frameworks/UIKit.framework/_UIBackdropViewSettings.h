...
@property (assign,nonatomic) char zoomsBack; 
...
@property (assign,nonatomic) float extendedRangeClamp;                                   //@synthesize extendedRangeClamp=_extendedRangeClamp - In the implementation block
