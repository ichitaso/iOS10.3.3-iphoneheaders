...
@property (assign,nonatomic) char applySaturationBeforeBlur;                                                              //@synthesize applySaturationBeforeBlur=_applySaturationBeforeBlur - In the implementation block
...
@property (assign,nonatomic) char autoGroup;                                                                              //@synthesize autoGroup=_autoGroup - In the implementation block
...
-(void)setAutoGroup:(char)arg1 ;
-(void)setApplySaturationBeforeBlur:(char)arg1 ;
...
-(char)applySaturationBeforeBlur;
