...
@interface UIInterfaceActionSelectionTrackingController : NSObject <UIGestureRecognizerDelegate, UIFocusedInterfaceActionPressDelegate> {
	...
	char _selectByPressGestureEnabled;
	char _selectionFeedbackEnabled;
...
@property (assign,nonatomic) char selectByPressGestureEnabled;                                                               //@synthesize selectByPressGestureEnabled=_selectByPressGestureEnabled - In the implementation block
@property (assign,nonatomic) char selectionFeedbackEnabled;                                                                  //@synthesize selectionFeedbackEnabled=_selectionFeedbackEnabled - In the implementation block
...
-(char)_isPresentedAndVisible;
-(char)_allowSelectionForCurrentGestureLocationWithGestureRecognizer:(id)arg1 ;
...
-(void)_noteScrollView:(id)arg1 isUserScrolling:(char)arg2 ;
-(char)_shouldDisableSelectionTrackingIfScrollingScrollView:(id)arg1 ;
...
-(void)setSelectByPressGestureEnabled:(char)arg1 ;
-(void)setSelectionFeedbackEnabled:(char)arg1 ;
-(void)setTrackableContainerView:(UIView *)arg1 ;
-(UIScrollView *)actionsScrollView;
-(void)setActionsScrollView:(UIScrollView *)arg1 ;
-(char)selectByPressGestureEnabled;
