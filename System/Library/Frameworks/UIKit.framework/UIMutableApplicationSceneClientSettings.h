...
@interface UIMutableApplicationSceneClientSettings : FBSMutableSceneClientSettings <UIApplicationSceneClientSettings> {
	...
	char _statusBarForegroundTransparent;

}

@property (assign,nonatomic) int statusBarStyle; 
@property (assign,nonatomic) char statusBarHidden; 
@property (assign,getter=isStatusBarForegroundTransparent,nonatomic) char statusBarForegroundTransparent;              //@synthesize statusBarForegroundTransparent=_statusBarForegroundTransparent - In the implementation block
...
-(void)setStatusBarForegroundTransparent:(char)arg1 ;
