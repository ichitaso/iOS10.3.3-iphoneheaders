...
@interface AVAssetWriterConfigurationState : NSObject {
	...
	SCD_Struct_AV2 _movieFragmentInterval;
	SCD_Struct_AV2 _overallDurationHint;
...
@property (assign,nonatomic) SCD_Struct_AV2 movieFragmentInterval;              //@synthesize movieFragmentInterval=_movieFragmentInterval - In the implementation block
@property (assign,nonatomic) SCD_Struct_AV2 overallDurationHint;                //@synthesize overallDurationHint=_overallDurationHint - In the implementation block
