...
+(id)imageWithImageProvider:(id)arg1 size:(unsigned long)arg2 :(unsigned long)arg3 format:(int)arg4 colorSpace:(CGColorSpaceRef)arg5 options:(id)arg6 ;
...
-(id)initWithImageProvider:(/*^block*/id)arg1 width:(unsigned long)arg2 height:(unsigned long)arg3 format:(int)arg4 colorSpace:(CGColorSpaceRef)arg5 options:(id)arg6 ;
...
-(id)initWithImageProvider:(id)arg1 size:(unsigned long)arg2 :(unsigned long)arg3 format:(int)arg4 colorSpace:(CGColorSpaceRef)arg5 options:(id)arg6 ;
-(id)_initWithImageProvider:(/*^block*/id)arg1 width:(unsigned long)arg2 height:(unsigned long)arg3 format:(int)arg4 colorSpace:(CGColorSpaceRef)arg5 surfaceCache:(BOOL)arg6 options:(id)arg7 ;
-(id)smartToneAdjustmentsForValue:(double)arg1 andStatistics:(id)arg2 ;
