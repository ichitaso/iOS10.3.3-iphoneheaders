...
@property (assign,nonatomic) char generateExceprts;                                  //@synthesize generateExceprts=_generateExceprts - In the implementation block
...
-(void)setGenerateExceprts:(char)arg1 ;
