...
-(void)getLocalizedNameWithBundleType:(id)arg1 bundleIdentifier:(id)arg2 bundleUUID:(id)arg3 context:(id)arg4 shortNameOnly:(char)arg5 preferredLocalizations:(id)arg6 completionHandler:(/*^block*/id)arg7 ;
