...
-(void)performOpenOperationWithURL:(id)arg1 applicationIdentifier:(id)arg2 documentIdentifier:(id)arg3 sourceIsManaged:(char)arg4 userInfo:(id)arg5 options:(id)arg6 delegate:(id)arg7 completionHandler:(/*^block*/id)arg8 ;
-(void)failedToOpenApplication:(id)arg1 withURL:(id)arg2 ;
-(void)canOpenURL:(id)arg1 publicSchemes:(char)arg2 privateSchemes:(char)arg3 completionHandler:(/*^block*/id)arg4 ;
