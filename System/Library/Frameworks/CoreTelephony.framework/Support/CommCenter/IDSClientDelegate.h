...
@property (retain) NSArray * fSupportedDevices;                               //@synthesize fSupportedDevices=_fSupportedDevices - In the implementation block
...
@property (retain) NSMutableDictionary * fCachedUpdate;                       //@synthesize fCachedUpdate=_fCachedUpdate - In the implementation block
...
-(void)setFSupportedDevices:(NSArray *)arg1 ;
...
-(void)setFCachedUpdate:(NSMutableDictionary *)arg1 ;
