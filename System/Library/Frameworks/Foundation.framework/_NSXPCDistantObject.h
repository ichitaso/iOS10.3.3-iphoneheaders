...
@property (assign) char _noImportance;                               //@synthesize noImportance=_noImportance - In the implementation block
@property (readonly) char _sync; 
...
-(void)set_noImportance:(char)arg1 ;
