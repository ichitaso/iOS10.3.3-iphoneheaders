...
@class NSString, NSDictionary, NSBundle, NSMutableDictionary, NSSet, BKSProcessAssertion, NSUUID, NSObject, NSArray;
...
@property (getter=_isMarkedNew,nonatomic,readonly) char _markedNew; 
...
@property (assign,setter=_setAssertionRefCount:,nonatomic) int _assertionRefCount;                                                                           //@synthesize _assertionRefCount=__assertionRefCount - In the implementation block
...
@property (nonatomic,readonly) char optedIn; 
