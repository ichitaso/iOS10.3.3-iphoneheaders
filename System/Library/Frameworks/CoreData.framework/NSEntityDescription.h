...
-(char)_hasUniquePropertiesUncached;
-(void)_commonCachesAndOptimizedState;
-(void)_removePropertyNamed:(id)arg1 ;
-(void)_setIsFlattened:(char)arg1 ;
-(void)_stripForMigration;
-(void)_restoreValidation;
-(char)_hasUniquePropertiesDownInheritanceHiearchy;
-(char)_constraintIsExtension:(id)arg1 ;
...
-(char)_isPathologicalForConstraintMerging:(id*)arg1 ;
-(char)_hasUniqueProperties;
-(id)_extensionsOfParentConstraint:(id)arg1 ;
-(char)_hasUniquedAttributeWithName:(id)arg1 ;
