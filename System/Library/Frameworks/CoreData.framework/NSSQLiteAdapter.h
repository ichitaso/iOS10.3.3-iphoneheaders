...
-(id)newSelectStatementWithFetchRequest:(id)arg1 ignoreInheritance:(char)arg2 ;
...
-(id)_statementForFetchRequestContext:(id)arg1 ignoreInheritance:(char)arg2 countOnly:(char)arg3 nestingLevel:(unsigned)arg4 ;
...
-(char)generateCorrelationTableTriggerStatementsForRelationship:(id)arg1 existing:(CFDictionaryRef)arg2 correlationTableTriggers:(CFDictionaryRef)arg3 error:(id*)arg4 ;
-(char)generateTriggerForEntity:(id)arg1 alreadyCreated:(CFDictionaryRef)arg2 correlations:(CFDictionaryRef)arg3 fragments:(id)arg4 error:(id*)arg5 ;
...
-(id)newSelectStatementWithFetchRequestContext:(id)arg1 ignoreInheritance:(char)arg2 ;
