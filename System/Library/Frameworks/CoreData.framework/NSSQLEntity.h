...
-(void)_setHasAttributesMonitoredByTriggers:(char)arg1 ;
-(void)_setHasAttributesBackedByTriggers:(char)arg1 ;
...
-(char)_hasAttributesMonitoredByTriggers;
-(char)_hasAttributesBackedByTriggers;
-(void)dealloc;
-(id)description;
-(id)name;
-(id)model;
