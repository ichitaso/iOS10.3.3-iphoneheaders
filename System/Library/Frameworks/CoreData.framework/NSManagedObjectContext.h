...
@property (assign,nonatomic) char shouldPerformSecureOperation; 
...
-(char)_doPreSaveConstraintChecksForObjects:(id)arg1 error:(id*)arg2 ;
...
-(void)_setAutomaticallyMergesChangesFromParent:(char)arg1 ;
...
-(unsigned)_fetchLimitForRequest:(id)arg1 ;
...
-(void)_createAndPostChangeNotification:(id)arg1 deletions:(id)arg2 updates:(id)arg3 refreshes:(id)arg4 deferrals:(id)arg5 wasMerge:(char)arg6 ;
...
-(void)_managedObjectContextEditor:(id)arg1 didCommit:(char)arg2 contextInfo:(SCD_Struct_NS11*)arg3 ;
...
-(void)performWithOptions:(unsigned)arg1 andBlock:(/*^block*/id)arg2 ;
