...
-(id)sendMessage:(id)arg1 fromContext:(id)arg2 interrupts:(unsigned*)arg3 error:(id*)arg4 ;
...
-(id)_executeSaveRequest:(id)arg1 forceInsertsToUpdates:(char)arg2 withContext:(id)arg3 interrupts:(unsigned*)arg4 error:(id*)arg5 ;
