...
@interface FBDPostUpload : NSObject <NSURLConnectionDataDelegate> {
	...
	unsigned _quietRetryFailedRequestsCount;
...
-(char)_handleRetry;
-(char)_promptRetryNotificationWithFailedRequestsCountNotice:(unsigned)arg1 ;
-(char)_handleQuietRetry;
...
-(void)handleResponse:(id)arg1 withError:(id)arg2 didRetry:(char*)arg3 ;
-(char)suppressAlerts;
-(id)facebookIconURL;
