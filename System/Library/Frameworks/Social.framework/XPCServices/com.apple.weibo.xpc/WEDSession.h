...
#import <libobjc.A.dylib/SLWeiboRemoteSessionProtocol.h>
...
+(void)_migrateWeiboDataWithMigrationController:(id)arg1 ;
...
-(char)_weiboWasADuplicate:(id)arg1 errorString:(id)arg2 ;
-(char)_wasWeiboLimitReached:(id)arg1 responseObject:(id)arg2 ;
-(char)_weiboAuthenticationFailure:(id)arg1 errorString:(id)arg2 ;
-(id)weiboIconURL;
