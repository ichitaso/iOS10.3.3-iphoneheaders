...
-(void)withSourceForIdentifier:(CFStringRef)arg1 user:(CFStringRef)arg2 byHost:(char)arg3 container:(CFStringRef)arg4 cloud:(char)arg5 perform:(/*^block*/id)arg6 ;
...
-(void)with23930198HackSourceForIdentifier:(CFStringRef)arg1 user:(CFStringRef)arg2 byHost:(char)arg3 container:(CFStringRef)arg4 cloud:(char)arg5 perform:(/*^block*/id)arg6 ;
...
-(char)appValueIsForcedForKey:(CFStringRef)arg1 appIdentifier:(CFStringRef)arg2 ;
-(char)hasCloudValueForKey:(CFStringRef)arg1 appIdentifier:(CFStringRef)arg2 container:(CFStringRef)arg3 configurationURL:(CFURLRef)arg4 ;
-(char)hasNonRegisteredValueForKey:(CFStringRef)arg1 appIdentifier:(CFStringRef)arg2 container:(CFStringRef)arg3 configurationURL:(CFURLRef)arg4 ;
...
-(void)setBackupDisabled:(char)arg1 identifier:(CFStringRef)arg2 user:(CFStringRef)arg3 host:(CFStringRef)arg4 container:(CFStringRef)arg5 ;
-(void)setAccessRestricted:(char)arg1 forAppIdentifier:(CFStringRef)arg2 ;
...
-(void)setCloudSyncEnabled:(char)arg1 forKey:(CFStringRef)arg2 appIdentifier:(CFStringRef)arg3 container:(CFStringRef)arg4 ;
