...
-(SCD_Struct_NS14)_minimumRangeOfUnit:(unsigned)arg1 ;
-(SCD_Struct_NS14)_maximumRangeOfUnit:(unsigned)arg1 ;
-(SCD_Struct_NS14)_rangeOfUnit:(unsigned)arg1 inUnit:(unsigned)arg2 forAT:(double)arg3 ;
