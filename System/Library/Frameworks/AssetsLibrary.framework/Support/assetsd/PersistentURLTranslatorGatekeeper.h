...
-(void)cleanupInvalidIgnoreDates:(id)arg1 connection:(id)arg2 ;
...
-(id)_startCPLDownloadForAsset:(id)arg1 resourceType:(unsigned)arg2 masterResourceOnly:(char)arg3 highPriority:(char)arg4 track:(char)arg5 notify:(char)arg6 transient:(char)arg7 proposedTaskIdentifier:(id)arg8 doneToken:(id)arg9 error:(id*)arg10 ;
-(void)_sendClientCPLStatusWithVirtualTaskIdentifier:(id)arg1 downloadContext:(id)arg2 ;
-(id)_newPlatformDependentXPCObjectWithBuffer:(void*)arg1 length:(unsigned long)arg2 ;
-(id)_startCPLDownloadForAsset:(id)arg1 resourceType:(unsigned)arg2 masterResourceOnly:(char)arg3 highPriority:(char)arg4 track:(char)arg5 notify:(char)arg6 proposedTaskIdentifier:(id)arg7 doneToken:(id)arg8 error:(id*)arg9 ;
