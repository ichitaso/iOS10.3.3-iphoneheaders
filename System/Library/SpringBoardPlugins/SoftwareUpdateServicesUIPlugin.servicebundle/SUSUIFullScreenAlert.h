...
@interface SUSUIFullScreenAlert : NSObject

@property (nonatomic,retain,readonly) SBSRemoteAlertDefinition * remoteDefinition; 
-(SBSRemoteAlertDefinition *)remoteDefinition;
