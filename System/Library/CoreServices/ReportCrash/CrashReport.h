...
-(void)finishExtractionUsingCorpse:(char)arg1 ;
...
-(void)_extractBacktraceInfoUsingSymbolicator:(CSTypeRef)arg1 usingCorpse:(char)arg2 ;
-(void)captureDiagInfo:(id)arg1 ;
-(id)exceptionCodesDescriptionWithPrefix:(char)arg1 ;
-(id)slice_uuid;
-(char*)_copyStringFromTask:(unsigned)arg1 atAddress:(unsigned long long)arg2 immutableOnly:(char)arg3 ;
-(VMURange)_regionAtAddress:(unsigned long long)arg1 immutableOnly:(char)arg2 ;
-(id)_readDataFromMemory:(mapped_memory_tRef)arg1 atAddress:(unsigned long long)arg2 size:(unsigned long)arg3 ;
-(id)_readStringAtTaskAddress:(unsigned long long)arg1 immutableOnly:(char)arg2 ;
-(void)_extractCrashReporterAnnotationsFromSymbolOwner:(CSTypeRef)arg1 withMemory:(mapped_memory_tRef)arg2 internal:(char)arg3 ;
