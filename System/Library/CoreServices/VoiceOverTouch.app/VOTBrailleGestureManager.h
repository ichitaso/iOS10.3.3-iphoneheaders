...
@class VOTBrailleGestureTranslator, VOTBrailleGestureSpellingSuggestionHandler, BKSAccelerometer, NSMutableDictionary, NSString, NSDictionary, AXDispatchTimer, NSArray;
...
@interface VOTBrailleGestureManager : VOTGesturedTextInputManager <VOTBrailleGestureTranslatorDelegate, BKSAccelerometerDelegate> {
	...
	AXDispatchTimer* _speakingDelayTimer;
	AXDispatchTimer* _brailleTypingPropertiesAnnouncementTimer;
	AXDispatchTimer* _warningTonesTimer;
	AXDispatchTimer* _lockScreenDimmingTimer;
	AXDispatchTimer* _logBSIUsageTimer;
...
@property (nonatomic,retain) AXDispatchTimer * speakingDelayTimer;                                            //@synthesize speakingDelayTimer=_speakingDelayTimer - In the implementation block
@property (nonatomic,retain) AXDispatchTimer * brailleTypingPropertiesAnnouncementTimer;                      //@synthesize brailleTypingPropertiesAnnouncementTimer=_brailleTypingPropertiesAnnouncementTimer - In the implementation block
@property (nonatomic,retain) AXDispatchTimer * warningTonesTimer;                                             //@synthesize warningTonesTimer=_warningTonesTimer - In the implementation block
...
@property (nonatomic,retain) AXDispatchTimer * lockScreenDimmingTimer;                                        //@synthesize lockScreenDimmingTimer=_lockScreenDimmingTimer - In the implementation block
@property (nonatomic,retain) AXDispatchTimer * logBSIUsageTimer;                                              //@synthesize logBSIUsageTimer=_logBSIUsageTimer - In the implementation block
...
-(void)setLockScreenDimmingTimer:(AXDispatchTimer *)arg1 ;
...
-(void)_speakText:(id)arg1 useKeyboardLanguage:(char)arg2 shouldQueue:(char)arg3 isInsert:(char)arg4 isDelete:(char)arg5 speakLiterally:(char)arg6 ;
...
-(void)setBrailleTypingPropertiesAnnouncementTimer:(AXDispatchTimer *)arg1 ;
...
-(void)setSpeakingDelayTimer:(AXDispatchTimer *)arg1 ;
...
-(void)setWarningTonesTimer:(AXDispatchTimer *)arg1 ;
-(void)_beginExploringDotPatterns;
-(void)_playWarningTones:(unsigned)arg1 completion:(/*^block*/id)arg2 ;
-(void)_handleTouchPoints:(id)arg1 ;
-(void)_speakText:(id)arg1 hint:(id)arg2 useKeyboardLanguage:(char)arg3 shouldQueue:(char)arg4 isInsert:(char)arg5 isDelete:(char)arg6 speakLiterally:(char)arg7 otherLanguage:(id)arg8 ;
...
-(void)setLogBSIUsageTimer:(AXDispatchTimer *)arg1 ;
-(int)typingMode;
