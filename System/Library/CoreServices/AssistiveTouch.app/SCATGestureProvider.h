...
@property (assign,nonatomic) CGPoint currentHoldPoint;                                  //@synthesize currentHoldPoint=_currentHoldPoint - In the implementation block
...
-(void)setCurrentHoldPoint:(CGPoint)arg1 ;
...
-(id)gesturesSheet;
-(void)performHoldAtPoint:(CGPoint)arg1 isDown:(char)arg2 ;
