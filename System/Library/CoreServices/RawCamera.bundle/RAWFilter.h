...
-(id)apply:(id)arg1 image:(id)arg2 extent:(CGRect)arg3 roi:(SEL)arg4 userInfo:(id)arg5 arguments:(id)arg6 inoutSpace:(CGColorSpaceRef)arg7 isAlphaOne:(char)arg8 ;
