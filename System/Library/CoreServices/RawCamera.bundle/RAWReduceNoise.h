...
-(id)viewDIR:(id)arg1 do360:(char)arg2 crop:(CGRect)arg3 ;
-(id)viewTGDIR:(id)arg1 lothresh:(float)arg2 factor:(float)arg3 do360:(char)arg4 crop:(CGRect)arg5 ;
...
-(id)viewGDIR:(id)arg1 do360:(char)arg2 crop:(CGRect)arg3 ;
