...
@property (assign,nonatomic) float speedMultiplierForFadeIn;                          //@synthesize speedMultiplierForFadeIn=_speedMultiplierForFadeIn - In the implementation block
@property (assign,nonatomic) float speedMultiplierForLiftToWake;                      //@synthesize speedMultiplierForLiftToWake=_speedMultiplierForLiftToWake - In the implementation block
...
-(float)speedMultiplierForLiftToWake;
-(float)speedMultiplierForFadeIn;
...
-(void)setSpeedMultiplierForFadeIn:(float)arg1 ;
-(void)setSpeedMultiplierForLiftToWake:(float)arg1 ;
