...
@interface SBLockScreenView : SBAlertView <UIScrollViewDelegate, _UIGlintyStringViewDelegate, _UISettingsKeyObserver, CAAnimationDelegate, SBCoordinatedPresenting, SBPresentingDelegate> {
	...
	char _isPresentingNotificationCenter;
...
-(void)setLogoutButtonHidden:(char)arg1 forRequester:(id)arg2 ;
-(char)isCurrentPageTransparent;
-(char)_reachedThreshold;
...
-(char)isRelinquishingDateViewGeometry;
-(void)_layoutGrabberView:(id)arg1 atTop:(char)arg2 percentScrolled:(float)arg3 ;
-(char)isRelinquishingTopGrabberGeometry;
-(char)isRelinquishingNotificationListViewGeometry;
-(void)_layoutLockView;
-(void)_layoutPasscodeView;
-(void)_layoutEmergencyCallView;
-(void)_layoutOverlayViews;
-(char)isRelinquishingBatteryViewGeometry;
-(int)pageNumberForLockScreenPage:(int)arg1 ;
-(float)horizontalOffsetForLockScreenPage:(int)arg1 ;
-(void)scrollToPage:(int)arg1 animated:(char)arg2 completion:(/*^block*/id)arg3 ;
-(char)_isValidPage:(int)arg1 ;
...
-(int)lockScreenPageForPageNumber:(int)arg1 ;
...
-(void)setMediaControlsHidden:(char)arg1 forRequester:(id)arg2 withAnimationFactory:(id)arg3 ;
-(void)setDeviceInformationTextHidden:(char)arg1 forRequester:(id)arg2 ;
...
-(void)_setRelinqish:(char)arg1 geometryOfElementWithRequesters:(id*)arg2 forRequester:(id)arg3 ;
-(void)setRelinquishNotificationListViewGeometry:(char)arg1 forRequester:(id)arg2 ;
-(void)setRelinquishDateViewGeometry:(char)arg1 forRequester:(id)arg2 ;
-(void)setRelinquishBatteryViewGeometry:(char)arg1 forRequester:(id)arg2 ;
-(void)setRelinquishTopGrabberGeometry:(char)arg1 forRequester:(id)arg2 ;
-(char)isRelinquishingMediaControlsGeometry;
-(void)setRelinquishMediaControlsGeometry:(char)arg1 forRequester:(id)arg2 ;
-(void)shakeSlideToUnlockTextWithCustomText:(id)arg1 ;
-(void)setCustomSlideToUnlockLanguage:(id)arg1 ;
-(void)_setMediaControlsHidden:(char)arg1 forRequester:(id)arg2 withAnimationFactory:(id)arg3 allowAnimationForNilFactory:(char)arg4 ;
-(void)_setMediaControlsHidden:(char)arg1 forRequester:(id)arg2 ;
