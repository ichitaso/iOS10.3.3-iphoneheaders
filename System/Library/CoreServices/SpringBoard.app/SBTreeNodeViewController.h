...
@interface SBTreeNodeViewController : UIViewController <SBViewControllerTransitionContextDelegate, SBTreeNodeViewControllerDelegate> {
	...
	int _currentTransitionOperation;
...
-(void)_setExpandedTreeNode:(id)arg1 animated:(char)arg2 withCompletion:(/*^block*/id)arg3 ;
-(id<SBTreeNode>)treeNode;
-(void)popExpandedTreeNodeAnimated:(char)arg1 withCompletion:(/*^block*/id)arg2 ;
-(void)pushExpandedTreeNode:(id)arg1 animated:(char)arg2 withCompletion:(/*^block*/id)arg3 ;
...
-(char)isExpandedForContainingExpandedTreeNode:(id)arg1 ;
-(void)_handleWillAddChildViewController:(id)arg1 ;
-(void)_handleRemoveChildViewController:(id)arg1 ;
-(CGRect)frameForChildTreeNodeViewController:(id)arg1 inState:(int)arg2 withParentContainerSize:(CGSize)arg3 ;
...
-(char)_shouldAddViewController:(id)arg1 afterTransitionFromViewController:(id)arg2 toViewController:(id)arg3 canceled:(char)arg4 ;
-(char)_shouldRemoveViewController:(id)arg1 afterTransitionFromViewController:(id)arg2 toViewController:(id)arg3 canceled:(char)arg4 ;
-(char)_shouldAddViewController:(id)arg1 afterTransitionFromViewController:(id)arg2 toViewController:(id)arg3 ;
-(char)_shouldRemoveViewController:(id)arg1 afterTransitionFromViewController:(id)arg2 toViewController:(id)arg3 ;
...
-(void)_transitionToExpandedTreeNode:(id)arg1 animated:(char)arg2 withCompletion:(/*^block*/id)arg3 ;
-(void)_forwardToExpandedViewControllerNearestToTreeNode:(id)arg1 withNodeModifier:(/*^block*/id)arg2 block:(/*^block*/id)arg3 ;
-(void)setExpandedTreeNode:(id)arg1 animated:(char)arg2 withCompletion:(/*^block*/id)arg3 ;
-(void)_performOperation:(int)arg1 animated:(char)arg2 fromViewController:(id)arg3 fromTreeNode:(id)arg4 toViewController:(id)arg5 toTreeNode:(id)arg6 withContinuation:(/*^block*/id)arg7 completion:(/*^block*/id)arg8 ;
-(void)_forwardToExpandedViewControllerNearestToTreeNode:(id)arg1 block:(/*^block*/id)arg2 ;
-(char)_shouldAddViewControllerAfterCurrentTransitionCompletes:(id)arg1 ;
-(char)_shouldRemoveViewControllerAfterCurrentTransitionCompletes:(id)arg1 ;
