...
@class SBApplication, SBLockHardwareButtonActions, NSSet, SBButtonDownGestureRecognizer, SBTapGestureRecognizer, SBLongPressGestureRecognizer, SBPressSequenceObserver, SBSOSTriggerObserver, UIGestureRecognizer, SBHomeHardwareButton, NSString;
...
@interface SBLockHardwareButton : NSObject <UIGestureRecognizerDelegate, SBSOSTriggerObserverDelegate> {
	...
	SBPressSequenceObserver* _lockPressSequenceObserver;
...
@property (nonatomic,retain) SBPressSequenceObserver * lockPressSequenceObserver;                      //@synthesize lockPressSequenceObserver=_lockPressSequenceObserver - In the implementation block
...
@property (nonatomic,readonly) char isButtonDown; 
...
-(id)initWithScreenshotGestureRecognizer:(id)arg1 homeHardwareButton:(id)arg2 buttonActions:(id)arg3 createGestures:(char)arg4 ;
-(void)_createGestureRecognizers;
-(void)singlePress:(id)arg1 ;
-(void)sosGesture:(id)arg1 ;
-(void)loggingGesture:(id)arg1 ;
-(void)_reportAggdLoggingForButtonEventIsDownEvent:(char)arg1 ;
-(char)_tryToSendButtonDownEventsToAppForRecognizer:(id)arg1 ;
...
-(SBPressSequenceObserver *)lockPressSequenceObserver;
-(void)setLockPressSequenceObserver:(SBPressSequenceObserver *)arg1 ;
