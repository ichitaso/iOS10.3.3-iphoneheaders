...
@interface SBSynchronizeCloudCriticalDataOperation : NSObject {
	...
	unsigned _queue_operationCount;
	char _queue_isComplete;
...
-(char)waitForSynchronizeToCompleteWithTimeout:(double)arg1 ;
...
-(void)_fetchDomains:(id)arg1 fromIndex:(int)arg2 queue:(id)arg3 completion:(/*^block*/id)arg4 ;
-(unsigned)_pendingOperationCount;
