...
+(void)_setClearAllLegacySnapshotsWhenLoaded:(char)arg1 ;
...
-(void)_noteApplicationIconChanged:(id)arg1 ;
...
-(void)_removeApplicationsFromModelWithBundleIdentifier:(id)arg1 forInstall:(char)arg2 withReason:(id)arg3 ;
