...
@property (assign,getter=isClippingDisabled,nonatomic) char clippingDisabled;                                //@synthesize clippingDisabled=_clippingDisabled - In the implementation block
...
-(NSString *)requester;
-(void)setClippingDisabled:(char)arg1 ;
-(char)isClippingDisabled;
