...
@property (nonatomic,readonly) SCD_Struct_SB45 flags;                                   //@synthesize flags=_flags - In the implementation block
-(id)initWithObserver:(id)arg1 flags:(SCD_Struct_SB45)arg2 ;
-(id<SBAlertManagerObserver>)observer;
-(SCD_Struct_SB45)flags;
@end
