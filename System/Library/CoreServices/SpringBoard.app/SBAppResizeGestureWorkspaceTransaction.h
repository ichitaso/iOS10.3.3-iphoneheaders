...
-(id)_workspaceTransitionRequestForCurrentLayoutStateWithSuspendingPrimaryApplication:(char)arg1 suspendingSideApplication:(char)arg2 ;
...
-(void)_updateElementViewsAlphaAndGrabberForGestureRegion:(unsigned)arg1 ;
