...
@property (getter=isPrototypingEnabled,nonatomic,readonly) char prototypingEnabled;              //@synthesize isEnabled=_isEnabled - In the implementation block
@property (getter=isShowingSettingsUI,nonatomic,readonly) char showingSettingsUI;                //@synthesize showingSettings=_showingSettings - In the implementation block
