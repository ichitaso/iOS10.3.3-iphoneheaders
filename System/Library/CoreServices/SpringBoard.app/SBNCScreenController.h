...
@property (assign,nonatomic) char turnOnScreenForOutOfPocketEvent;                               //@synthesize turnOnScreenForOutOfPocketEvent=_turnOnScreenForOutOfPocketEvent - In the implementation block
...
-(void)_turnOnScreen;
-(char)canTurnOnScreenForNotificationRequest:(id)arg1 ;
...
-(char)turnOnScreenForOutOfPocketEvent;
-(void)setTurnOnScreenForOutOfPocketEvent:(char)arg1 ;
