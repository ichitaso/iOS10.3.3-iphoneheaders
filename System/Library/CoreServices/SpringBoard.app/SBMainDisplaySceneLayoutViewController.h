...
+(char)getAnchorEdge:(out unsigned*)arg1 forLayoutRole:(int)arg2 shouldReverseLayoutDirection:(char)arg3 ;
+(unsigned)convertAnchorEdge:(unsigned)arg1 toLayoutOrientation:(int)arg2 ;
...
-(void)_pushSideAppControllerForSwitcher:(id)arg1 withAnimationSettings:(id)arg2 fadeIn:(char)arg3 completion:(/*^block*/id)arg4 ;
...
-(char)getAnchorEdge:(out unsigned*)arg1 forLayoutRole:(int)arg2 ;
...
-(void)_pushSideAppOverlayController:(id)arg1 dimOtherViews:(char)arg2 withAnimationSettings:(id)arg3 fadeIn:(char)arg4 completion:(/*^block*/id)arg5 ;
...
-(unsigned)anchorEdgeForLayoutRole:(int)arg1 ;
