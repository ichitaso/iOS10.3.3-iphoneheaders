...
-(void)addViewController:(id)arg1 animated:(char)arg2 completion:(/*^block*/id)arg3 ;
-(void)removeViewController:(id)arg1 animated:(char)arg2 completion:(/*^block*/id)arg3 ;
-(void)_queuePendingTransition:(id)arg1 ;
-(void)_performPendingTransitionIfNecessary;
-(void)_removePendingTransition:(id)arg1 forSuccess:(char)arg2 ;
...
-(void)removeViewControllerAnimated:(char)arg1 completion:(/*^block*/id)arg2 ;
