...
+(id)bannerTextForAdditionalAttachments:(unsigned)arg1 showingImage:(char)arg2 ;
...
+(id)_listImageForAttachmentType:(int)arg1 thumbnailData:(id)arg2 forFloatingAlert:(char)arg3 ;
