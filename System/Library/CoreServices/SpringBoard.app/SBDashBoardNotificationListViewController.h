...
@class NCNotificationPriorityListViewController, MTMaterialView, SBDashBoardClippingLine, SBFTouchPassThroughView, NSHashTable, BSTimer, NSMutableDictionary, NSMutableSet, NCNotificationRequest, NSString;
...
@interface SBDashBoardNotificationListViewController : SBDashBoardViewControllerBase <NCNotificationListViewControllerUserInteractionDelegate, NCNotificationListViewControllerDestinationDelegate, SBMotionGestureObserver, SBDashBoardNotificationDestination> {
	...
	float _headerOffset;
	float _footerOffset;
	char _listPresentingContent;
	char _listDismissingContent;
	char _listBeingLaidOut;
	NSHashTable* _notificationEffectViews;
	BSTimer* _significantUserInteractionTimer;
	char _listSuppressLongLookDismissal;
...
@property (nonatomic,readonly) char hasContent;                                                                  //@synthesize listPresentingContent=_listPresentingContent - In the implementation block
...
-(void)_setListHasContent:(char)arg1 ;
-(void)setActiveRaiseToListenNotificationRequest:(NCNotificationRequest *)arg1 ;
-(void)_clearContentIncludingPersistent:(char)arg1 ;
...
-(char)_notificationSectionSettingsHidesSection:(id)arg1 ;
...
-(void)notificationListViewController:(id)arg1 setRaiseGestureDetectionEnabled:(char)arg2 forNotificationRequest:(id)arg3 ;
...
-(char)notificationListViewController:(id)arg1 shouldAllowInteractionsForNotificationRequest:(id)arg2 ;
-(char)notificationListViewController:(id)arg1 showSupplementaryActionsForNotificationRequest:(id)arg2 ;
