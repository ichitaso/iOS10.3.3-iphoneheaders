...
-(id)initWithWarnTimer:(id)arg1 expireTimer:(id)arg2 resetPolicy:(int)arg3 unwarnPolicy:(int)arg4 unwarnInterval:(double)arg5 ;
...
-(void)compoundTimer:(id)arg1 willMoveFromIndex:(unsigned)arg2 toIndex:(unsigned)arg3 ;
-(void)compoundTimer:(id)arg1 didMoveFromIndex:(unsigned)arg2 toIndex:(unsigned)arg3 ;
-(id)initWithCompoundTimer:(id)arg1 warnOnly:(char)arg2 resetPolicy:(int)arg3 unwarnPolicy:(int)arg4 unwarnInterval:(double)arg5 ;
-(void)resetToOriginalTimer:(char)arg1 ;
-(id)init;
