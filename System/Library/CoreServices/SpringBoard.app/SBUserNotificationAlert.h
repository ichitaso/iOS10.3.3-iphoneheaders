...
@interface SBUserNotificationAlert : SBAlertItem {
	...
	int _defaultButtonActionStyle;
	int _alternateButtonActionStyle;
	int _otherButtonActionStyle;
...
@property (assign) int soundAlertType;                                                      //@synthesize soundAlertType=_soundAlertType - In the implementation block
...
-(id)initWithMessage:(id)arg1 replyPort:(unsigned)arg2 requestFlags:(int)arg3 auditToken:(SCD_Struct_SB21)arg4 ;
...
-(int)_uiAlertActionStyleFromSBUserNotificationButtonPresentationStyle:(int)arg1 ;
...
-(char)allowInLoginWindow;
-(char)dismissesOverlaysOnLockScreen;
-(void)_noteVolumeOrLockPressed;
-(char)_displayActionButtonOnLockScreen;
