...
-(void)applyPictureInPictureInsets:(UIEdgeInsets)arg1 fromSource:(int)arg2 duration:(double)arg3 ;
...
-(void)_setPictureInPictureWindowMargin:(UIEdgeInsets)arg1 animationDuration:(double)arg2 animationOptions:(unsigned)arg3 ;
