...
-(void)_continueLayoutTransitionToCompletion:(char)arg1 startAutoPiP:(char)arg2 updateScenes:(char)arg3 ;
-(void)_cancelPendingAppLaunch;
-(void)_gestureEndedWithCompletionType:(int)arg1 ;
-(void)_gestureCancelled;
-(void)_continueLayoutTransitionWithContext:(id)arg1 toCompletion:(char)arg2 startAutoPiP:(char)arg3 updateScenes:(char)arg4 ;
