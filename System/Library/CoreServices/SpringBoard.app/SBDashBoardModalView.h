...
@interface SBDashBoardModalView : SBDashBoardViewBase <SBLockScreenModalView> {
	...
	char _showsStatusText;
	char _needsTitleConstraints;
	char _needsSubTitleConstraints;
	char _needsPrimaryActionConstraints;
	char _needsSecondaryActionConstraints;
	char _needsImageConstraints;
	char _showsDateView;
...
@property (assign,nonatomic) char showsDateView;                                                                                                    //@synthesize showsDateView=_showsDateView - In the implementation block
@property (assign,nonatomic) char showsStatusText;                                                                                                  //@synthesize showsStatusText=_showsStatusText - In the implementation block
