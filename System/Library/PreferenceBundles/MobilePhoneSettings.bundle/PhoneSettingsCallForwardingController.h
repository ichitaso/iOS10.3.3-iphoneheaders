...
@interface PhoneSettingsCallForwardingController : PhoneSettingsListController {
	...
	int _interfaceState;
	int _previousState;
	char _isSettingForwardingStateFromStoredNumber;
...
-(char)_shouldDisplayExtendedInterface;
...
-(void)_setMasterSwitchEnabled:(char)arg1 ;
-(void)_setUnconditionalCellEnabled:(char)arg1 ;
...
-(void)_setMasterSwitchLoading:(char)arg1 ;
-(void)_setNumberFieldsEnabled:(char)arg1 ;
-(void)_setSwitcherFieldsEnabled:(char)arg1 ;
