...
@property (readonly) unsigned vpnConnectionType;                           //@synthesize vpnConnectionType=_vpnConnectionType - In the implementation block
