...
-(unsigned)updateNetworkSpinnerVisibility;
...
-(void)setEnterpriseVPNActive:(char)arg1 specifier:(id)arg2 ;
-(void)setPersonalVPNActive:(char)arg1 specifier:(id)arg2 ;
...
-(void)addListForGrade:(unsigned)arg1 toSpecifiers:(id)arg2 ;
