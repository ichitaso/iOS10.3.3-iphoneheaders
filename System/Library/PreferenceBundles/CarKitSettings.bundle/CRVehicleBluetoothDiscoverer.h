...
@property (assign,nonatomic) char discoveryEnabled;                                                          //@synthesize discoveryEnabled=_discoveryEnabled - In the implementation block
...
-(void)handleChangedDiscoveryState:(char)arg1 ;
-(void)setDiscoveryEnabled:(char)arg1 ;
-(void)_allowBluetoothConnections:(char)arg1 ;
-(char)discoveryEnabled;
