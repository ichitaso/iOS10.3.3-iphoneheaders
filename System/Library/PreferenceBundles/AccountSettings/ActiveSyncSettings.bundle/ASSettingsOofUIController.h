...
* on Saturday, December 30, 2017 at 4:28:58 PM Japan Standard Time
...
@interface ASSettingsOofUIController : ACUIViewController <UITextContentViewDelegate> {
	...
	unsigned _ASOutOfOfficeDirtyStates;
...
@property (assign,nonatomic) unsigned ASOutOfOfficeDirtyStates;                          //@synthesize ASOutOfOfficeDirtyStates=_ASOutOfOfficeDirtyStates - In the implementation block
...
-(id)externalSpecifersToRemoveAll:(char)arg1 ;
...
-(unsigned)ASOutOfOfficeDirtyStates;
-(void)setASOutOfOfficeDirtyStates:(unsigned)arg1 ;
...
-(void)_insertAdditionalExternalSpecifiersAnimated:(char)arg1 ;
-(void)_removeAdditionalExternalSpecifiersAnimated:(char)arg1 ;
